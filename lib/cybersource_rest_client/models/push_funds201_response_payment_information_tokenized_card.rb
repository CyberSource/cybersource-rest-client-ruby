...
module CyberSource
  class PushFunds201ResponsePaymentInformationTokenizedCard
    ...
    def list_invalid_properties
      ...
      #if !@assurance_method.nil? && @assurance_method !~ Regexp.new(/^(\\s{0,2}|.{2})$/)
        #invalid_properties.push('invalid value for "assurance_method", must conform to the pattern /^(\\s{0,2}|.{2})$/.')
      #end
    ...
    def valid?
      #return false if !@assurance_method.nil? && @assurance_method !~ Regexp.new(/^(\\s{0,2}|.{2})$/)
      true
    end
    ...
    def assurance_method=(assurance_method)
      #if !assurance_method.nil? && assurance_method !~ Regexp.new(/^(\\s{0,2}|.{2})$/)
        #fail ArgumentError, 'invalid value for "assurance_method", must conform to the pattern /^(\\s{0,2}|.{2})$/.'
      #end
