...
module CyberSource
  class AgenticRetrievePaymentCredentialsResponse200TransactionResponseComplete
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'signedPayload')
        self.signed_payload = attributes[:'signedPayload']
      end
    end
    ...
    def hash
      [client_correlation_id, instruction_id, status, authorization, signed_payload].hash
    end
