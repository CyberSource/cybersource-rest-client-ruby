...
module CyberSource
  class ValidateExportComplianceRequest
    ...
    attr_accessor :export_compliance_information
    ...
    def self.json_map
      {
        ...
        :'export_compliance_information' => :'export_compliance_information'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'exportComplianceInformation')
        self.export_compliance_information = attributes[:'exportComplianceInformation']
      end
    end
    ...
    def hash
      [client_reference_information, order_information, buyer_information, device_information, export_compliance_information].hash
    end
