...
module CyberSource
  class Acpv1instructionsinstructionIdcredentialsMandateReferenceData
    ...
    def list_invalid_properties
      ...
      #if !@mandate_id.nil? && @mandate_id !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
    ...
    def valid?
      #return false if !@mandate_id.nil? && @mandate_id !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
      true
    end
