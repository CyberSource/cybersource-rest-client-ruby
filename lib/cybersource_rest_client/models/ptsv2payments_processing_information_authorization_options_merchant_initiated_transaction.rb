...
module CyberSource
  class Ptsv2paymentsProcessingInformationAuthorizationOptionsMerchantInitiatedTransaction
    ...
    def list_invalid_properties
      ...
      if !@reason.nil? && @reason.to_s.length > 1
        invalid_properties.push('invalid value for "reason", the character length must be smaller than or equal to 1.')
      end
    ...
    def reason=(reason)
      if !reason.nil? && reason.to_s.length > 1
        fail ArgumentError, 'invalid value for "reason", the character length must be smaller than or equal to 1.'
      end
