...
module CyberSource
  class InlineResponse20012PaymentInformationAccountFeatures
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'previousBalanceAmount')
        self.previous_balance_amount = attributes[:'previousBalanceAmount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          previous_balance_amount == o.previous_balance_amount &&
          currency == o.currency
    end
    ...
    def hash
      [balance_amount, previous_balance_amount, currency].hash
    end
