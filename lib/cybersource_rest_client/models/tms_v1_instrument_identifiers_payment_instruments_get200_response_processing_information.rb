...
module CyberSource
  class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseProcessingInformation
    ...
    def self.swagger_types
      {
        ...
        :'bank_transfer_options' => :'TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseProcessingInformationBankTransferOptions'
      }
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bill_payment_program_enabled == o.bill_payment_program_enabled &&
    ...
    def hash
      [bill_payment_program_enabled, bank_transfer_options].hash
    end
