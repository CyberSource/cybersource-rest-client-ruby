...
module CyberSource
  class Ptsv2payoutsfxratesClientReferenceInformation
    ...
    def self.swagger_types
      {
        ...
        :'code' => :'String',
        :'partner' => :'Ptsv2payoutsfxratesClientReferenceInformationPartner'
      }
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] application_user Value to be assigned
    def application_user=(application_user)
      @application_user = application_user
    end
    ...
    def hash
      [application_name, application_version, application_user, code, partner].hash
    end
