...
module CyberSource
  class InlineResponse20013AccountInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastAccessTime')
        self.last_access_time = attributes[:'lastAccessTime']
      end
    ...
    def hash
      [user_name, role_id, permissions, status, created_time, last_access_time, language_preference, timezone].hash
    end
