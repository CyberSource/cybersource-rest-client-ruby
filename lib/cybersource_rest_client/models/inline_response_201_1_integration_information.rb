...
module CyberSource
  class InlineResponse2011IntegrationInformation
    ...
    def self.swagger_types
      {
        :'tenant_configurations' => :'Array<InlineResponse2011IntegrationInformationTenantConfigurations>'
      }
    end
