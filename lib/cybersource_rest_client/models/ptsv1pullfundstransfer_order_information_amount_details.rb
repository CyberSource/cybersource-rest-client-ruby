...
module CyberSource
  class Ptsv1pullfundstransferOrderInformationAmountDetails
    ...
    attr_accessor :foreign_exchange_fee
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'foreignExchangeFee')
        self.foreign_exchange_fee = attributes[:'foreignExchangeFee']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] foreign_exchange_fee Value to be assigned
    def foreign_exchange_fee=(foreign_exchange_fee)
      @foreign_exchange_fee = foreign_exchange_fee
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          foreign_exchange_fee == o.foreign_exchange_fee &&
    ...
    def hash
      [total_amount, currency, service_fee, foreign_exchange_fee, surcharge].hash
    end
