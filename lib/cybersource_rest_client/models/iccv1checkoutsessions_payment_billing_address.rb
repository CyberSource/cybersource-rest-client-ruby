...
module CyberSource
  ...
  class Iccv1checkoutsessionsPaymentBillingAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_locality')
        self.address_locality = attributes[:'address_locality']
      end

      if attributes.has_key?(:'address_region')
        self.address_region = attributes[:'address_region']
      end
    ...
    def hash
      [street_address, address_locality, address_region, address_country, postal_code].hash
    end
