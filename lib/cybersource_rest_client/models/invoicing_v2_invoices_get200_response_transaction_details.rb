...
module CyberSource
  ...
  class InvoicingV2InvoicesGet200ResponseTransactionDetails
    ...
    def list_invalid_properties
      ...
      if !@amount.nil? && @amount.to_s.length > 19
        invalid_properties.push('invalid value for "amount", the character length must be smaller than or equal to 19.')
      end
    ...
    def valid?
      return false if !@amount.nil? && @amount.to_s.length > 19
      true
    end
    ...
    def amount=(amount)
      if !amount.nil? && amount.to_s.length > 19
        fail ArgumentError, 'invalid value for "amount", the character length must be smaller than or equal to 19.'
      end
