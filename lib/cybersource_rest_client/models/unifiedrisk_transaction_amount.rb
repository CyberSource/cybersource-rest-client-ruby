...
module CyberSource
  class UnifiedriskTransactionAmount
    ...
    # Base currency for multi-currency transactions
    attr_accessor :base_currency

    # Amount in base currency
    attr_accessor :base_value

    # ISO 4217 3-letter code for the merchant's local currency used to express the transaction amount (e.g., EUR for EU merchants). Used for cross-currency risk analysis
    ...
    def hash
      [value, currency, base_currency, base_value, merchant_currency, merchant_value].hash
    end
