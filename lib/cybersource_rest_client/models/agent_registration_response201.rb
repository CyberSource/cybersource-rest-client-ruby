...
module CyberSource
  ...
  class AgentRegistrationResponse201
    ...
    def self.swagger_types
      {
        ...
        :'created_at' => :'DateTime',
        :'updated_at' => :'DateTime',
        :'keys' => :'Array<AgentRegistrationResponse201Keys>'
      }
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          agent_metadata == o.agent_metadata &&
    ...
    def hash
      [id, name, domain, description, contact_email, token_requestor_id, agent_type, agent_metadata, is_active, created_at, updated_at, keys].hash
    end
