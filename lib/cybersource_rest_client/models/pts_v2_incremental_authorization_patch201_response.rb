...
module CyberSource
  class PtsV2IncrementalAuthorizationPatch201Response
    ...
    def hash
      [_links, id, submit_time_utc, status, reconciliation_id, error_information, client_reference_information, processor_information, payment_information, order_information].hash
    end
