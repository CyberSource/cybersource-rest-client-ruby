  ...
  class PaymentsProductsServiceFeeConfigurationInformationConfigurations
    ...
    def self.swagger_types
      {
        ...
        :'payment_information' => :'Array<PaymentsProductsServiceFeeConfigurationInformationConfigurationsPaymentInformation>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentInformation')
        if (value = attributes[:'paymentInformation']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      #if !@terminal_id.nil? && @terminal_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
        #invalid_properties.push('invalid value for "terminal_id", must conform to the pattern /^[a-zA-Z0-9]+$/.')
      #end

      #if !@merchant_id.nil? && @merchant_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
        #invalid_properties.push('invalid value for "merchant_id", must conform to the pattern /^[a-zA-Z0-9]+$/.')
      #end
    ...
    def valid?
      #return false if !@terminal_id.nil? && @terminal_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
      #return false if !@merchant_id.nil? && @merchant_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
      true
    end
    ...
    def terminal_id=(terminal_id)
      #if !terminal_id.nil? && terminal_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
        #fail ArgumentError, 'invalid value for "terminal_id", must conform to the pattern /^[a-zA-Z0-9]+$/.'
      #end
    ...
    def merchant_id=(merchant_id)
      #if !merchant_id.nil? && merchant_id !~ Regexp.new(/^[a-zA-Z0-9]+$/)
        #fail ArgumentError, 'invalid value for "merchant_id", must conform to the pattern /^[a-zA-Z0-9]+$/.'
      #end
    ...
    def hash
      [products, terminal_id, merchant_id, merchant_information, payment_information].hash
    end
