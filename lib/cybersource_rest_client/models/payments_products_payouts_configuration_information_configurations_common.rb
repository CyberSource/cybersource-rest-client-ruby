...
module CyberSource
  class PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentTypes')
        if (value = attributes[:'paymentTypes']).is_a?(Array)
          self.payment_types = value
        end
      end

      if attributes.has_key?(:'businessApplicationId')
        if (value = attributes[:'businessApplicationId']).is_a?(Array)
          self.business_application_id = value
        end
      end
