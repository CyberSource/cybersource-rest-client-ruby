...
module CyberSource
  class ReportingV3ReportDefinitionsGet200ResponseReportDefinitions
    ...
    attr_accessor :report_defintion_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reportDefintionName')
        self.report_defintion_name = attributes[:'reportDefintionName']
      end

      if attributes.has_key?(:'supportedFormats')
        if (value = attributes[:'supportedFormats']).is_a?(Array)
