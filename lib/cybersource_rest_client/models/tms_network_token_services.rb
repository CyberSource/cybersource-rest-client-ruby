...
module CyberSource
  class TmsNetworkTokenServices
    ...
    attr_accessor :payment_credentials

    attr_accessor :synchronous_provisioning

    attr_accessor :visa_token_service

    attr_accessor :mastercard_digital_enablement_service

    attr_accessor :american_express_token_service
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentCredentials')
        self.payment_credentials = attributes[:'paymentCredentials']
      end

      if attributes.has_key?(:'synchronousProvisioning')
        self.synchronous_provisioning = attributes[:'synchronousProvisioning']
      end
      ...
      if attributes.has_key?(:'americanExpressTokenService')
        self.american_express_token_service = attributes[:'americanExpressTokenService']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_credentials == o.payment_credentials &&
          synchronous_provisioning == o.synchronous_provisioning &&
          visa_token_service == o.visa_token_service &&
          mastercard_digital_enablement_service == o.mastercard_digital_enablement_service &&
          american_express_token_service == o.american_express_token_service
    end
    ...
    def hash
      [notifications, payment_credentials, synchronous_provisioning, visa_token_service, mastercard_digital_enablement_service, american_express_token_service].hash
    end
