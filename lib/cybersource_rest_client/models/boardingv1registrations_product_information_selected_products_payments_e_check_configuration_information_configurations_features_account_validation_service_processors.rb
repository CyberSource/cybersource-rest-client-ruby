...
module CyberSource
  ...
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsECheckConfigurationInformationConfigurationsFeaturesAccountValidationServiceProcessors
    ...
    def hash
      [avs_account_ownership_service, avs_account_status_service, avs_signed_agreement, avs_additional_id, enable_avs, avs_entity_id, enable_avs_token_creation].hash
    end
