...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsECheckConfigurationInformationConfigurationsCommonInternalOnly
    ...
    def self.json_map
      {
        :'display_echeck_info' => :'display_echeck_info',
        :'processors' => :'processors'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'displayEcheckInfo')
        self.display_echeck_info = attributes[:'displayEcheckInfo']
      else
        self.display_echeck_info = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          display_echeck_info == o.display_echeck_info &&
    ...
    def hash
      [display_echeck_info, processors].hash
    end
