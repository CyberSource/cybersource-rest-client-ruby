...
module CyberSource
  class Ptsv1pullfundstransferAggregatorInformation
    ...
    def self.swagger_types
      {
        ...
        :'name' => :'String',
        :'sub_merchant' => :'Ptsv1pullfundstransferAggregatorInformationSubMerchant',
        :'city' => :'String',
        :'country' => :'String',
        :'postal_code' => :'String',
        :'state' => :'String',
    ...
    def hash
      [aggregator_id, name, sub_merchant, city, country, postal_code, state, street_address].hash
    end
