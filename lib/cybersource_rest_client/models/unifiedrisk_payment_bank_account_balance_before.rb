...
module CyberSource
  class UnifiedriskPaymentBankAccountBalanceBefore
    ...
    # Pre-transaction account balance expressed in the merchant's local currency, used for cross-currency balance comparison and risk analysis
