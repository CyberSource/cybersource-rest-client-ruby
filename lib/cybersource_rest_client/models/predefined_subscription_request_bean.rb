  ...
  class PredefinedSubscriptionRequestBean
    ...
    def list_invalid_properties
      ...
      if @report_definition_name.nil?
        ...
        #invalid_properties.push('invalid value for "report_definition_name", must conform to the pattern /[a-zA-Z]+/.')
      #end
    ...
    def valid?
      ...
      #return false if @report_definition_name !~ Regexp.new(/[a-zA-Z]+/)
    ...
    def hash
      [report_definition_name, subscription_type, report_name, report_mime_type, report_frequency, report_interval, timezone, start_time, start_day, subscription_status].hash
    end
