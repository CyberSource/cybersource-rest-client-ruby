...
module CyberSource
  class PullFunds201ResponseOrderInformationAmountDetails
    ...
    def list_invalid_properties
      ...
      #if !@currency.nil? && @currency !~ Regexp.new(/^(\\s{0,3}|.{3})$/)
    ...
    def valid?
      #return false if !@currency.nil? && @currency !~ Regexp.new(/^(\\s{0,3}|.{3})$/)
      true
    end
