...
module CyberSource
  class Nrtfv1webhookswebhookIdreplaysByDeliveryStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hoursBack')
        self.hours_back = attributes[:'hoursBack']
      end
    ...
    def hash
      [status, start_time, end_time, hours_back, product_id, event_type].hash
    end
