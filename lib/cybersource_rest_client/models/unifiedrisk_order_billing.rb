...
module CyberSource
  class UnifiedriskOrderBilling
    ...
    def hash
      [address_line1, address_line2, administrative_area, country, locality, first_name, last_name, phone_number, email, postal_code, address_line3].hash
    end
