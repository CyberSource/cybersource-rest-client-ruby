...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentInstallment
    ...
    def self.json_map
      {
        :'enable_installment' => :'enable_installment',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enableInstallment')
        self.enable_installment = attributes[:'enableInstallment']
      end

      if attributes.has_key?(:'installmentPlan')
        self.installment_plan = attributes[:'installmentPlan']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable_installment == o.enable_installment &&
    ...
    def hash
      [enable_installment, installment_plan].hash
    end
