...
module CyberSource
  class RiskV1AuthenticationExemptionsPost201Response
    ...
    def hash
      [_links, id, submit_time_utc, status, risk_information, consumer_authentication_information, error_information].hash
    end
