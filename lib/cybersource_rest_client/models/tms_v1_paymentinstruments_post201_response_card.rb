...
module CyberSource
  class TmsV1PaymentinstrumentsPost201ResponseCard
    ...
    def list_invalid_properties
      ...
      if !@expiration_month.nil? && @expiration_month.to_s.length > 12
        invalid_properties.push('invalid value for "expiration_month", the character length must be smaller than or equal to 12.')
      end

      if !@expiration_month.nil? && @expiration_month.to_s.length < 1
        invalid_properties.push('invalid value for "expiration_month", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      return false if !@expiration_month.nil? && @expiration_month.to_s.length > 12
      return false if !@expiration_month.nil? && @expiration_month.to_s.length < 1
    ...
    def expiration_month=(expiration_month)
      if !expiration_month.nil? && expiration_month.to_s.length > 12
        fail ArgumentError, 'invalid value for "expiration_month", the character length must be smaller than or equal to 12.'
      end

      if !expiration_month.nil? && expiration_month.to_s.length < 1
        fail ArgumentError, 'invalid value for "expiration_month", the character length must be great than or equal to 1.'
      end
