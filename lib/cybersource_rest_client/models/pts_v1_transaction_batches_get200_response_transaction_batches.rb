...
module CyberSource
  class PtsV1TransactionBatchesGet200ResponseTransactionBatches
    ...
    attr_accessor :accepted_transaction_count

    # Number of transactions rejected.
    attr_accessor :rejected_transaction_count
    ...
    def hash
      [id, upload_date, completion_date, transaction_count, accepted_transaction_count, rejected_transaction_count, status].hash
    end
