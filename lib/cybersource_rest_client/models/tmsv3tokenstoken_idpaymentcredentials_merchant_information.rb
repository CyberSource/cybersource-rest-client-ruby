...
module CyberSource
  class Tmsv3tokenstokenIdpaymentcredentialsMerchantInformation
    ...
    def self.swagger_types
      {
        :'merchant_descriptor' => :'Tmsv3tokenstokenIdpaymentcredentialsMerchantInformationMerchantDescriptor'
      }
    end
