...
module CyberSource
  class InlineResponse20012ProcessorInformationElectronicVerificationResults
    ...
    def hash
      [email, email_raw, name, name_raw, phone_number, phone_number_raw, street, street_raw, postal_code, postal_code_raw].hash
    end
