...
module CyberSource
  class PullFunds201Response
    ...
    def self.swagger_types
      {
        ...
        :'_links' => :'PullFunds201ResponseLinks'
      }
    end
    ...
    def hash
      [id, submit_time_utc, order_information, status, error_information, processor_information, _links].hash
    end
