...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsRisk
    attr_accessor :fraud_management_essentials
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fraudManagementEssentials')
        self.fraud_management_essentials = attributes[:'fraudManagementEssentials']
      end
