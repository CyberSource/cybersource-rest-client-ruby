...
module CyberSource
  # Buyer and payment details required to place the order. 
  class AcpCompleteCheckoutRequest
    attr_accessor :buyer
    ...
    def self.swagger_types
      {
        :'buyer' => :'AcpCompleteCheckoutSessionBuyer',
        :'payment_data' => :'Iccv1checkoutSessionssessionIdcompletePaymentData'
      }
    end
