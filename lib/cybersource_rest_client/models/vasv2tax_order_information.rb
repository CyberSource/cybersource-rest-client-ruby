...
module CyberSource
  class Vasv2taxOrderInformation
    ...
    def self.swagger_types
      {
        ...
        :'line_items' => :'Array<Vasv2taxOrderInformationLineItems>',
    ...
    def hash
      [amount_details, bill_to, shipping_details, ship_to, line_items, invoice_details, order_acceptance, order_origin].hash
    end
