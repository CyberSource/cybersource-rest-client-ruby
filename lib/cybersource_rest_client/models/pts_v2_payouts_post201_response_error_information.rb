...
module CyberSource
  class PtsV2PayoutsPost201ResponseErrorInformation
    ...
    def valid?
      reason_validator = EnumAttributeValidator.new('String', ['EXPIRED_CARD', 'PROCESSOR_DECLINED', 'STOLEN_LOST_CARD', 'UNAUTHORIZED_CARD', 'CVN_NOT_MATCH', 'INVALID_CVN', 'BLACKLISTED_CUSTOMER', 'INVALID_ACCOUNT', 'GENERAL_DECLINE', 'RISK_CONTROL_DECLINE', 'PROCESSOR_RISK_CONTROL_DECLINE'])
