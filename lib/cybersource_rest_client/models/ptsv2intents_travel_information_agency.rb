...
module CyberSource
  class Ptsv2intentsTravelInformationAgency
    ...
    def self.json_map
      {
        ...
        :'end_date' => :'end_date',
        :'change_of_guest' => :'change_of_guest',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'changeOfGuest')
        self.change_of_guest = attributes[:'changeOfGuest']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          change_of_guest == o.change_of_guest &&
    ...
    def hash
      [start_date, end_date, change_of_guest, country_code, locality, postal_code].hash
    end
