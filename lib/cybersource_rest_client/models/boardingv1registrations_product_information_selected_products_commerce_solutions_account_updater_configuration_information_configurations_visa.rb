...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsCommerceSolutionsAccountUpdaterConfigurationInformationConfigurationsVisa
    ...
    def hash
      [merchant_id, segment_id, active].hash
    end
