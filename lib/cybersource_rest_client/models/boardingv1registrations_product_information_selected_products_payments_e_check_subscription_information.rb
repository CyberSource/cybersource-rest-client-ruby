...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsECheckSubscriptionInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mode')
        if (value = attributes[:'mode']).is_a?(Array)
          self.mode = value
        end
      end
    end
    ...
    def hash
      [enabled, self_serviceability, mode].hash
    end
