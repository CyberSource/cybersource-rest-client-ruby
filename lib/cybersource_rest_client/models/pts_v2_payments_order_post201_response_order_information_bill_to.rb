...
module CyberSource
  class PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo
    ...
    def hash
      [title, first_name, middle_name, last_name, name_suffix, address1, address2, locality, postal_code, administrative_area, country, email, phone_number, verification_status].hash
    end
