...
module CyberSource
  class PtsV2PaymentsPost201ResponseIssuerInformation
    ...
    attr_accessor :pin_request_indicator
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pinRequestIndicator')
    ...
    # Custom attribute writer method with validation
    # @param [Object] pin_request_indicator Value to be assigned
    def pin_request_indicator=(pin_request_indicator)
      @pin_request_indicator = pin_request_indicator
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pin_request_indicator == o.pin_request_indicator
    end
    ...
    def hash
      [country, discretionary_data, country_specific_discretionary_data, response_code, pin_request_indicator].hash
    end
