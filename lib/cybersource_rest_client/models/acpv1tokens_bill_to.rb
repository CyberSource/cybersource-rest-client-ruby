...
module CyberSource
  ...
  class Acpv1tokensBillTo
    ...
    def list_invalid_properties
      ...
      #if !@full_name.nil? && @full_name !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
        #invalid_properties.push('invalid value for "full_name", must conform to the pattern /(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/.')
      #end
    ...
    def valid?
      ...
      #return false if !@full_name.nil? && @full_name !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
    ...
    def full_name=(full_name)
      #if !full_name.nil? && full_name !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
        #fail ArgumentError, 'invalid value for "full_name", must conform to the pattern /(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/.'
      #end
    ...
    def hash
      [first_name, last_name, full_name, email, country_calling_code, phone_number, number_is_voice_only, country].hash
    end
