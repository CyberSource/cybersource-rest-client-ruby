...
module CyberSource
  class UnifiedriskPaymentVerificationDigital
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tokenAuth')
        self.token_auth = attributes[:'tokenAuth']
      end
    end
    ...
    def hash
      [digital_signature, cryptogram, token_auth].hash
    end
