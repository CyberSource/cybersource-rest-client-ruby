...
module CyberSource
  class UnifiedriskTransactionRecurringDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'firstPaymentDate')
        self.first_payment_date = attributes[:'firstPaymentDate']
      end
    end
    ...
    def hash
      [frequency, occurrence, end_date, number_of_payments, sequence_number, type, validation_indicator, amount_type, maximum_amount, original_purchase_date, reference_number, first_payment_date].hash
    end
