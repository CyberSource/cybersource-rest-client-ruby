...
module CyberSource
  class CreateDecisionManagerCaseRequest
    ...
    def hash
      [client_reference_information, processor_information, payment_information, order_information, buyer_information, device_information, card_verification, risk_information, travel_information, merchant_defined_information].hash
    end
