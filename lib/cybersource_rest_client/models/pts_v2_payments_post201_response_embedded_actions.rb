...
module CyberSource
  ...
  class PtsV2PaymentsPost201ResponseEmbeddedActions
    ...
    attr_accessor :validate_consumer_authentication
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'CONSUMER_AUTHENTICATION')
        self.consumer_authentication = attributes[:'CONSUMER_AUTHENTICATION']
      end

      if attributes.has_key?(:'VALIDATE_CONSUMER_AUTHENTICATION')
        self.validate_consumer_authentication = attributes[:'VALIDATE_CONSUMER_AUTHENTICATION']
      end
