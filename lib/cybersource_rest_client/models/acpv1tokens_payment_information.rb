...
module CyberSource
  ...
  class Acpv1tokensPaymentInformation
    ...
    def list_invalid_properties
      ...
      if @instrument_identifier.nil?
        invalid_properties.push('invalid value for "instrument_identifier", instrument_identifier cannot be nil.')
      end
    ...
    def valid?
      return false if @instrument_identifier.nil?
      true
    end
    ...
    def hash
      [customer, payment_instrument, instrument_identifier].hash
    end
