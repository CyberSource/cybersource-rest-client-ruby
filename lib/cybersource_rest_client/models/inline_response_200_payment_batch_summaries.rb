...
module CyberSource
  class InlineResponse200PaymentBatchSummaries
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'salesCount')
        self.sales_count = attributes[:'salesCount']
      end

      if attributes.has_key?(:'salesAmount')
        self.sales_amount = attributes[:'salesAmount']
      end

      if attributes.has_key?(:'creditCount')
        self.credit_count = attributes[:'creditCount']
      end
    ...
    def hash
      [currency_code, payment_sub_type_description, start_time, end_time, sales_count, sales_amount, credit_count, credit_amount, account_name, account_id, merchant_id, merchant_name].hash
    end
