...
module CyberSource
  class TssV2TransactionsGet200ResponseBankAccountValidation
    ...
    attr_accessor :raw_validation_code
    ...
    def self.json_map
      {
        :'raw_validation_code' => :'raw_validation_code',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rawValidationCode')
        self.raw_validation_code = attributes[:'rawValidationCode']
      end
      ...
      if attributes.has_key?(:'resultMessage')
        self.result_message = attributes[:'resultMessage']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          raw_validation_code == o.raw_validation_code &&
    ...
    def hash
      [raw_validation_code, result_code, result_message].hash
    end
