...
module CyberSource
  class PtsV1TransactionBatchesGet200Response
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transactionBatches')
        if (value = attributes[:'transactionBatches']).is_a?(Array)
          self.transaction_batches = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          transaction_batches == o.transaction_batches &&
          _links == o._links &&
    ...
    def hash
      [transaction_batches, _links, submit_time_utc].hash
    end
