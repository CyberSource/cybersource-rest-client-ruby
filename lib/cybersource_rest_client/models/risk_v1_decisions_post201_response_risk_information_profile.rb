...
module CyberSource
  class RiskV1DecisionsPost201ResponseRiskInformationProfile
    ...
    attr_accessor :desination_queue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'desinationQueue')
        self.desination_queue = attributes[:'desinationQueue']
      end

      if attributes.has_key?(:'selectorRule')
        self.selector_rule = attributes[:'selectorRule']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          desination_queue == o.desination_queue &&
          selector_rule == o.selector_rule
    end
    ...
    def hash
      [name, desination_queue, selector_rule].hash
    end
