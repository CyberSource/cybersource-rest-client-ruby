...
module CyberSource
  class InlineResponse2011
    ...
    def self.swagger_types
      {
        ...
        :'product_information_setups' => :'Array<InlineResponse2011ProductInformationSetups>',
        :'message' => :'String',
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['INITIALIZED', 'RECEIVED', 'PROCESSING', 'SUCCESS', 'FAILURE', 'PARTIAL'])
