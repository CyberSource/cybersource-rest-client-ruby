...
module CyberSource
  class PullFundsReversal201Response
    ...
    def self.swagger_types
      {
        ...
        :'status' => :'String',
        :'error_information' => :'PullFundsReversal201ResponseErrorInformation',
        :'processor_information' => :'PullFundsReversal201ResponseProcessorInformation',
        :'_links' => :'PullFundsReversal201ResponseLinks'
      }
    end
    ...
    def hash
      [id, submit_time_utc, status, error_information, processor_information, _links].hash
    end
