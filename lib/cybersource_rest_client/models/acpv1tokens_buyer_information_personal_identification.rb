...
module CyberSource
  class Acpv1tokensBuyerInformationPersonalIdentification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'issueBy')
        self.issue_by = attributes[:'issueBy']
      end
    end
