...
module CyberSource
  class PaymentsProductsMicroformSubscriptionInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enablementStatus')
        self.enablement_status = attributes[:'enablementStatus']
      else
        self.enablement_status = 'ENABLED_AND_USABLE'
      end
    ...
    def hash
      [enabled, enablement_status, self_serviceability, features].hash
    end
