...
module CyberSource
  class Bavsv1accountvalidationsProcessingInformation
    ...
    def list_invalid_properties
      ...
      if @validation_level.nil?
        invalid_properties.push('invalid value for "validation_level", validation_level cannot be nil.')
      end
    ...
    def valid?
      return false if @validation_level.nil?
      true
    end
