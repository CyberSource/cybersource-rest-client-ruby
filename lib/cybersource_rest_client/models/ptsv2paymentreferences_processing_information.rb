...
module CyberSource
  class Ptsv2paymentreferencesProcessingInformation
    ...
    attr_accessor :payment_flow_mode
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentFlowMode')
        self.payment_flow_mode = attributes[:'paymentFlowMode']
      end
    ...
    # @param [Object] session_type Value to be assigned
    def session_type=(session_type)
      @session_type = session_type
    end

    # Custom attribute writer method with validation
    # @param [Object] payment_flow_mode Value to be assigned
    def payment_flow_mode=(payment_flow_mode)
      @payment_flow_mode = payment_flow_mode
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_flow_mode == o.payment_flow_mode &&
    ...
    def hash
      [session_type, payment_flow_mode, action_list].hash
    end
