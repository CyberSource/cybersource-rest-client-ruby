...
module CyberSource
  class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier
    ...
    def hash
      [_links, object, state, id, card, bank_account, processing_information, metadata].hash
    end
