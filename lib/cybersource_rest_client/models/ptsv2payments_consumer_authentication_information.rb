...
module CyberSource
  class Ptsv2paymentsConsumerAuthenticationInformation
    ...
    attr_accessor :authentication_brand
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authenticationBrand')
        self.authentication_brand = attributes[:'authenticationBrand']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] authentication_brand Value to be assigned
    def authentication_brand=(authentication_brand)
      @authentication_brand = authentication_brand
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          authentication_brand == o.authentication_brand &&
