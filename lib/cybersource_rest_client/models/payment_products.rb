...
module CyberSource
  class PaymentProducts
    ...
    def self.swagger_types
      {
        :'card_processing' => :'PaymentProductsCardProcessing',
        :'card_present_connect' => :'PaymentProductsCardPresentConnect',
        :'cybs_ready_terminal' => :'PaymentProductsCybsReadyTerminal',
        :'e_check' => :'PaymentProductsECheck',
        :'payer_authentication' => :'PaymentProductsPayerAuthentication',
        :'digital_payments' => :'PaymentProductsDigitalPayments',
        :'secure_acceptance' => :'PaymentProductsSecureAcceptance',
        :'virtual_terminal' => :'PaymentProductsVirtualTerminal',
        :'currency_conversion' => :'PaymentProductsCurrencyConversion',
        :'tax' => :'PaymentProductsTax',
        :'customer_invoicing' => :'PaymentProductsTax',
        :'recurring_billing' => :'PaymentProductsTax',
        :'payment_orchestration' => :'PaymentProductsTax',
        :'payouts' => :'PaymentProductsPayouts',
        :'differential_fee' => :'PaymentProductsDifferentialFee',
        :'pay_by_link' => :'PaymentProductsTax',
        :'unified_checkout' => :'PaymentProductsTax'
      }
    end
