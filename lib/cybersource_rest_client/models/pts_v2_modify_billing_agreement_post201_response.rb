...
module CyberSource
  class PtsV2ModifyBillingAgreementPost201Response
    ...
    def self.swagger_types
      {
        :'_links' => :'PtsV2ModifyBillingAgreementPost201ResponseLinks',
        :'id' => :'String',
    ...
    def hash
      [_links, id, submit_time_utc, status, processor_information, installment_information, client_reference_information, risk_information, agreement_information, order_information, payment_information].hash
    end
