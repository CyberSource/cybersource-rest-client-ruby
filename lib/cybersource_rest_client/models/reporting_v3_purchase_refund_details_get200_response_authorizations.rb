...
module CyberSource
  ...
  class ReportingV3PurchaseRefundDetailsGet200ResponseAuthorizations
    ...
    attr_accessor :authorization_request_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorizationRequestId')
        self.authorization_request_id = attributes[:'authorizationRequestId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          time == o.time &&
          authorization_request_id == o.authorization_request_id &&
          amount == o.amount &&
    ...
    def hash
      [request_id, transaction_reference_number, time, authorization_request_id, amount, currency_code, code, rcode].hash
    end
