...
module CyberSource
  class PtsV2PayoutsPost201ResponseRecipientInformationCard
    ...
    def list_invalid_properties
      ...
      if !@balance.nil? && @balance.to_s.length > 12
        invalid_properties.push('invalid value for "balance", the character length must be smaller than or equal to 12.')
      end
    ...
    def valid?
      return false if !@balance.nil? && @balance.to_s.length > 12
    ...
    def balance=(balance)
      if !balance.nil? && balance.to_s.length > 12
        fail ArgumentError, 'invalid value for "balance", the character length must be smaller than or equal to 12.'
      end
