...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsCommerceSolutions
    ...
    def self.swagger_types
      {
        :'token_management' => :'Boardingv1registrationsProductInformationSelectedProductsCommerceSolutionsTokenManagement',
        :'account_updater' => :'Boardingv1registrationsProductInformationSelectedProductsCommerceSolutionsAccountUpdater',
        :'bin_lookup' => :'Boardingv1registrationsProductInformationSelectedProductsCommerceSolutionsBinLookup'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountUpdater')
        self.account_updater = attributes[:'accountUpdater']
      end
