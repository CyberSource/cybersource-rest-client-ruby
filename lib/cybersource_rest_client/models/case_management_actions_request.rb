...
module CyberSource
  class CaseManagementActionsRequest
    attr_accessor :decision_information
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'decisionInformation')
        self.decision_information = attributes[:'decisionInformation']
      end
    ...
    def list_invalid_properties
      ...
      if @decision_information.nil?
        invalid_properties.push('invalid value for "decision_information", decision_information cannot be nil.')
      end
    ...
    def valid?
      return false if @decision_information.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          decision_information == o.decision_information &&
    ...
    def hash
      [decision_information, processing_information].hash
    end
