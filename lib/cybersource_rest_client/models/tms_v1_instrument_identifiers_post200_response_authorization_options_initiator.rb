...
module CyberSource
  class TmsV1InstrumentIdentifiersPost200ResponseProcessingInformationAuthorizationOptionsInitiator
    ...
    def self.swagger_types
      {
        :'merchant_initiated_transaction' => :'TmsV1InstrumentIdentifiersPost200ResponseProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction'
      }
    end
    ...
    def hash
      [merchant_initiated_transaction].hash
    end
