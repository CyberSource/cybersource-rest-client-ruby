...
module CyberSource
  class RiskV1AuthenticationResultsPost201Response
    ...
    def hash
      [_links, id, submit_time_utc, submit_time_local, status, reason, message, client_reference_information, consumer_authentication_information, error_information].hash
    end
