...
module CyberSource
  class Ucv1sessionsDataConsumerAuthenticationInformation
    ...
    # @param [Object] challenge_code Value to be assigned
    def challenge_code=(challenge_code)
      @challenge_code = challenge_code
    end

    # Custom attribute writer method with validation
    # @param [Object] message_category Value to be assigned
