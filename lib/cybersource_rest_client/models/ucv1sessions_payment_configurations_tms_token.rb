...
module CyberSource
  ...
  class Ucv1sessionsPaymentConfigurationsTMSTOKEN
    ...
    attr_accessor :instrument_identifiers
    ...
    def self.swagger_types
      {
        ...
        :'payment_instruments' => :'Array<Ucv1sessionsPaymentConfigurationsTMSTOKENPaymentInstruments>',
        :'instrument_identifiers' => :'Array<Ucv1sessionsPaymentConfigurationsTMSTOKENInstrumentIdentifiers>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'instrumentIdentifiers')
        if (value = attributes[:'instrumentIdentifiers']).is_a?(Array)
          self.instrument_identifiers = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          instrument_identifiers == o.instrument_identifiers
    end
    ...
    def hash
      [customer, payment_instruments, instrument_identifiers].hash
    end
