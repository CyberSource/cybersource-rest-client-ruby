...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsPayerAuthenticationConfigurationInformationConfigurationsCardTypesCB
    ...
    def hash
      [requestor_id, enabled, currencies].hash
    end
