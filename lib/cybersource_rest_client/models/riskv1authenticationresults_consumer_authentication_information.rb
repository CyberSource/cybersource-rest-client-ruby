...
module CyberSource
  class Riskv1authenticationresultsConsumerAuthenticationInformation
    ...
    def list_invalid_properties
      ...
      if @authentication_transaction_id.nil?
        invalid_properties.push('invalid value for "authentication_transaction_id", authentication_transaction_id cannot be nil.')
      end
    ...
    def valid?
      return false if @authentication_transaction_id.nil?
      true
    end
    ...
    def authentication_transaction_id=(authentication_transaction_id)
      #if authentication_transaction_id.nil?
        #fail ArgumentError, 'authentication_transaction_id cannot be nil'
      #end
    ...
    def hash
      [authentication_transaction_id, authentication_transaction_context, otp_token, response_access_token, signed_pares_status_reason, signed_pares, white_list_status, credential_encrypted].hash
    end
