...
module CyberSource
  class Ptsv2payoutsAggregatorInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'independentSalesOrganizationID')
        self.independent_sales_organization_id = attributes[:'independentSalesOrganizationID']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] independent_sales_organization_id Value to be assigned
    def independent_sales_organization_id=(independent_sales_organization_id)
      @independent_sales_organization_id = independent_sales_organization_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          independent_sales_organization_id == o.independent_sales_organization_id &&
    ...
    def hash
      [aggregator_id, name, independent_sales_organization_id, sub_merchant, street_address, city, state, postal_code, country].hash
    end
