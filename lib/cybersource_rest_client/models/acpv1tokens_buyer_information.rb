...
module CyberSource
  ...
  class Acpv1tokensBuyerInformation
    ...
    def self.swagger_types
      {
        ...
        :'personal_identification' => :'Array<Acpv1tokensBuyerInformationPersonalIdentification>',
        :'language' => :'String'
      }
    end
    ...
    def list_invalid_properties
      ...
      #if !@merchant_customer_id.nil? && @merchant_customer_id !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
        #invalid_properties.push('invalid value for "merchant_customer_id", must conform to the pattern /(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/.')
      #end
    ...
    def valid?
      #return false if !@merchant_customer_id.nil? && @merchant_customer_id !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
      true
    end
    ...
    def merchant_customer_id=(merchant_customer_id)
      #if !merchant_customer_id.nil? && merchant_customer_id !~ Regexp.new(/(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/)
        #fail ArgumentError, 'invalid value for "merchant_customer_id", must conform to the pattern /(?!^[*.,'#_\/-]+$)(?!.*\\.\/.*)^.*$/.'
      #end
    ...
    def hash
      [merchant_customer_id, personal_identification, language].hash
    end
