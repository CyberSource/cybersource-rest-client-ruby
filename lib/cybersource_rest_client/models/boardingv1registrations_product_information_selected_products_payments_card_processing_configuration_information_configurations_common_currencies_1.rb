...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1
    ...
    attr_accessor :enabled_card_present
    ...
    attr_accessor :enabled_card_not_present
    ...
    def hash
      [enabled, enabled_card_present, enabled_card_not_present, terminal_ids].hash
    end
