...
module CyberSource
  class SaveAsymEgressKey
    ...
    attr_accessor :client_request_action
    ...
    def self.json_map
      {
        ...
        :'client_request_action' => :'client_request_action',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientRequestAction')
        self.client_request_action = attributes[:'clientRequestAction']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_request_action == o.client_request_action &&
    ...
    def hash
      [client_reference_information, client_request_action, key_information].hash
    end
