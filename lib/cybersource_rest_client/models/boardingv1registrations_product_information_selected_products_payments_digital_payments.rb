...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsDigitalPayments
    ...
    def self.swagger_types
      {
        :'subscription_information' => :'Boardingv1registrationsProductInformationSelectedProductsPaymentsDigitalPaymentsSubscriptionInformation'
      }
    end
