...
module CyberSource
  class RiskV1AuthenticationSetupsPost201ResponseConsumerAuthenticationInformation
    ...
    attr_accessor :device_data_collection_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deviceDataCollectionUrl')
        self.device_data_collection_url = attributes[:'deviceDataCollectionUrl']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          device_data_collection_url == o.device_data_collection_url
    end
    ...
    def hash
      [access_token, reference_id, device_data_collection_url].hash
    end
