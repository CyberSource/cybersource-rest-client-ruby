...
module CyberSource
  ...
  class Kmsegressv2keysasymKeyInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pub')
        self.pub = attributes[:'pub']
      end
      ...
      if attributes.has_key?(:'pvt')
        self.pvt = attributes[:'pvt']
      end
    ...
    def hash
      [provider, tenant, key_type, organization_id, pub, key_id, pvt, status, expiry_duration].hash
    end
