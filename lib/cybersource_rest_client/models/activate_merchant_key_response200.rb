...
module CyberSource
  ...
  class ActivateMerchantKeyResponse200
    ...
    def hash
      [id, merchant_id, merchant_name, key_name, encryption_key, algorithm, encryption_type, expiration_date, status, created_at, updated_at].hash
    end
