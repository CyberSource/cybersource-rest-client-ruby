...
module CyberSource
  class PtsV2PaymentsOrderPost201Response
    ...
    def hash
      [id, client_reference_information, processor_information, order_information, payment_information, processing_information, buyer_information, submit_time_utc, status, reconciliation_id, risk_information].hash
    end
