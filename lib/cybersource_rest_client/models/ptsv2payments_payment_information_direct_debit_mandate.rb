...
module CyberSource
  class Ptsv2paymentsPaymentInformationDirectDebitMandate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clearingDate')
        self.clearing_date = attributes[:'clearingDate']
      end
    end
    ...
    # @param [Object] clearing_date Value to be assigned
    def clearing_date=(clearing_date)
      @clearing_date = clearing_date
    end
