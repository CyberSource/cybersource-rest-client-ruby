...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsDigitalPaymentsSubscriptionInformation
    ...
    def self.swagger_types
      {
        ...
        :'features' => :'Hash<String, Boardingv1registrationsProductInformationSelectedProductsPaymentsCardProcessingSubscriptionInformationFeatures>'
      }
    end
    ...
    def valid?
      self_serviceability_validator = EnumAttributeValidator.new('String', ['SELF_SERVICEABLE', 'NOT_SELF_SERVICEABLE', 'SELF_SERVICE_ONLY'])
    ...
    def self_serviceability=(self_serviceability)
      validator = EnumAttributeValidator.new('String', ['SELF_SERVICEABLE', 'NOT_SELF_SERVICEABLE', 'SELF_SERVICE_ONLY'])
    ...
    def hash
      [enabled, self_serviceability, features].hash
    end
