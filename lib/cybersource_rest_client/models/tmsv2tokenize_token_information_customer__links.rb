...
module CyberSource
  class Tmsv2tokenizeTokenInformationCustomerLinks
    attr_accessor :_self
    ...
    def self.swagger_types
      {
        :'_self' => :'Tmsv2tokenizeTokenInformationCustomerLinksSelf',
        :'payment_instruments' => :'Tmsv2tokenizeTokenInformationCustomerLinksPaymentInstruments',
    ...
    def hash
      [_self, payment_instruments, shipping_address].hash
    end
