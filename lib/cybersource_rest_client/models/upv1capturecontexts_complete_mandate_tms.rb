...
module CyberSource
  ...
  class Upv1capturecontextsCompleteMandateTms
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tokenCreate')
        self.token_create = attributes[:'tokenCreate']
      end

      if attributes.has_key?(:'tokenTypes')
        if (value = attributes[:'tokenTypes']).is_a?(Array)
