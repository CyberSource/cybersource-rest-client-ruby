...
module CyberSource
  class Ucv1sessionsPaymentConfigurationsGOOGLEPAY
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allowedAuthMethods')
        if (value = attributes[:'allowedAuthMethods']).is_a?(Array)
