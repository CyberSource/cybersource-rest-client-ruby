...
module CyberSource
  class ReportingV3ReportDefinitionsGet200Response
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reportDefinitions')
        if (value = attributes[:'reportDefinitions']).is_a?(Array)
          self.report_definitions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          report_definitions == o.report_definitions
    end
