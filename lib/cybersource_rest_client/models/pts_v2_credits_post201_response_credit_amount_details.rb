...
module CyberSource
  class PtsV2CreditsPost201ResponseCreditAmountDetails
    ...
    def list_invalid_properties
      ...
      if !@credit_amount.nil? && @credit_amount.to_s.length > 15
        invalid_properties.push('invalid value for "credit_amount", the character length must be smaller than or equal to 15.')
      end
    ...
    def valid?
      return false if !@credit_amount.nil? && @credit_amount.to_s.length > 15
    ...
    def credit_amount=(credit_amount)
      if !credit_amount.nil? && credit_amount.to_s.length > 15
        fail ArgumentError, 'invalid value for "credit_amount", the character length must be smaller than or equal to 15.'
      end
