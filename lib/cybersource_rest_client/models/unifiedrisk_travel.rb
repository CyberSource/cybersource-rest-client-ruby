  ...
  class UnifiedriskTravel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'legs')
        self.legs = attributes[:'legs']
      end

      if attributes.has_key?(:'passengers')
        self.passengers = attributes[:'passengers']
      end
    end
    ...
    def hash
      [actual_final_destination, complete_route, departure_time, journey_type, number_of_passengers, legs, passengers].hash
    end
