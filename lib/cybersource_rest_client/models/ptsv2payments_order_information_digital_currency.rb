...
module CyberSource
  ...
  class Ptsv2paymentsOrderInformationDigitalCurrency
    ...
    attr_accessor :ramp_provider_country
    ...
    attr_accessor :conversion_affiliate
    ...
    def self.swagger_types
      {
        :'type' => :'String',
        :'ramp_provider_country' => :'String',
        :'conversion_affiliate' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rampProviderCountry')
        self.ramp_provider_country = attributes[:'rampProviderCountry']
      end

      if attributes.has_key?(:'conversionAffiliate')
        self.conversion_affiliate = attributes[:'conversionAffiliate']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] ramp_provider_country Value to be assigned
    def ramp_provider_country=(ramp_provider_country)
      @ramp_provider_country = ramp_provider_country
    end

    # Custom attribute writer method with validation
    # @param [Object] conversion_affiliate Value to be assigned
    def conversion_affiliate=(conversion_affiliate)
      @conversion_affiliate = conversion_affiliate
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          ramp_provider_country == o.ramp_provider_country &&
          conversion_affiliate == o.conversion_affiliate
    end
    ...
    def hash
      [type, ramp_provider_country, conversion_affiliate].hash
    end
