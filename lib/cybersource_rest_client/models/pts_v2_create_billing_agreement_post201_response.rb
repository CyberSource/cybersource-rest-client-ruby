...
module CyberSource
  class PtsV2CreateBillingAgreementPost201Response
    ...
    def self.swagger_types
      {
        :'_links' => :'PtsV2CreateBillingAgreementPost201ResponseLinks',
        :'id' => :'String',
    ...
    def hash
      [_links, id, submit_time_utc, status, processor_information, installment_information, agreement_information, client_reference_information, risk_information, reconciliation_id].hash
    end
