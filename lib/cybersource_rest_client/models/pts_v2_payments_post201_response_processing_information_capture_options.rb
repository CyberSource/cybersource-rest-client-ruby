...
module CyberSource
  class PtsV2PaymentsPost201ResponseProcessingInformationCaptureOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'finalCapture')
        self.final_capture = attributes[:'finalCapture']
      end
    end
    ...
    # @param [Object] final_capture Value to be assigned
    def final_capture=(final_capture)
      @final_capture = final_capture
    end
