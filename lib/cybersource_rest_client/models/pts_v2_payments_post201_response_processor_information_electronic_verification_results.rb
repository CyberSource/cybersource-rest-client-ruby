...
module CyberSource
  class PtsV2PaymentsPost201ResponseProcessorInformationElectronicVerificationResults
    ...
    def list_invalid_properties
      ...
      if !@code_raw.nil? && @code_raw.to_s.length > 1
        invalid_properties.push('invalid value for "code_raw", the character length must be smaller than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@code_raw.nil? && @code_raw.to_s.length > 1
    ...
    def code_raw=(code_raw)
      if !code_raw.nil? && code_raw.to_s.length > 1
        fail ArgumentError, 'invalid value for "code_raw", the character length must be smaller than or equal to 1.'
      end
