...
module CyberSource
  ...
  class Ptsv2paymentsProcessingInformationCardVerification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'checkAVS')
        self.check_avs = attributes[:'checkAVS']
      end

      if attributes.has_key?(:'checkANI')
        self.check_ani = attributes[:'checkANI']
      end
    end
    ...
    # @param [Object] check_avs Value to be assigned
    def check_avs=(check_avs)
      @check_avs = check_avs
    end

    # Custom attribute writer method with validation
    # @param [Object] check_ani Value to be assigned
    def check_ani=(check_ani)
      @check_ani = check_ani
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          check_avs == o.check_avs &&
          check_ani == o.check_ani
    end
