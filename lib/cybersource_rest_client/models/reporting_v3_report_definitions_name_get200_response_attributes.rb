...
module CyberSource
  class ReportingV3ReportDefinitionsNameGet200ResponseAttributes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supportedType')
        self.supported_type = attributes[:'supportedType']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default == o.default &&
          required == o.required &&
          supported_type == o.supported_type
    end
    ...
    def hash
      [id, name, description, filter_type, default, required, supported_type].hash
    end
