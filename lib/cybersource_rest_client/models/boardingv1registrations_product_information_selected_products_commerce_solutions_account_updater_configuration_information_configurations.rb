...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsCommerceSolutionsAccountUpdaterConfigurationInformationConfigurations
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'masterCard')
        self.master_card = attributes[:'masterCard']
      end

      if attributes.has_key?(:'visa')
        self.visa = attributes[:'visa']
      end

      if attributes.has_key?(:'amex')
        self.amex = attributes[:'amex']
      end
      ...
      if attributes.has_key?(:'daysWindow')
        self.days_window = attributes[:'daysWindow']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] days_window Value to be assigned
    def days_window=(days_window)
      @days_window = days_window
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          master_card == o.master_card &&
          visa == o.visa &&
          amex == o.amex &&
          preferred_day == o.preferred_day &&
          days_window == o.days_window
    end
    ...
    def hash
      [master_card, visa, amex, preferred_day, days_window].hash
    end
