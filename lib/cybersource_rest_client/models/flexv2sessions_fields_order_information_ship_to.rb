...
module CyberSource
  class Flexv2sessionsFieldsOrderInformationShipTo
    ...
    def hash
      [address1, address2, administrative_area, building_number, country, district, locality, postal_code, first_name, last_name, company].hash
    end
