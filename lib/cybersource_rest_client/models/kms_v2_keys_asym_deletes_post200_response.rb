...
module CyberSource
  class KmsV2KeysAsymDeletesPost200Response
    ...
    def self.swagger_types
      {
        ...
        :'key_information' => :'Array<KmsV2KeysAsymDeletesPost200ResponseKeyInformation>'
      }
    end
    ...
    def hash
      [submit_time_utc, client_reference_information, key_information].hash
    end
