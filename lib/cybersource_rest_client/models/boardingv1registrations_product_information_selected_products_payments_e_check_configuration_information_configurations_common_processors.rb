...
module CyberSource
  ...
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsECheckConfigurationInformationConfigurationsCommonProcessors
    ...
    def hash
      [company_entry_description, company_id, batch_group, enable_accuity_for_avs, set_completed_state].hash
    end
