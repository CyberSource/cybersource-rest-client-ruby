...
module CyberSource
  ...
  class ListMerchantKeysResponse200
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalKeys')
        self.total_keys = attributes[:'totalKeys']
      end
    end
    ...
    def hash
      [merchant_id, merchant_name, merchant_url, keys, total_keys].hash
    end
