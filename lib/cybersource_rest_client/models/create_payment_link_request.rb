...
module CyberSource
  class CreatePaymentLinkRequest
    ...
    attr_accessor :purchase_information
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'purchaseInformation')
        self.purchase_information = attributes[:'purchaseInformation']
      end
    ...
    def list_invalid_properties
      ...
      if @purchase_information.nil?
        invalid_properties.push('invalid value for "purchase_information", purchase_information cannot be nil.')
      end
    ...
    def hash
      [client_reference_information, processing_information, purchase_information, order_information, merchant_defined_field_values].hash
    end
