...
module CyberSource
  class RiskV1AuthenticationResultsPost201ResponseConsumerAuthenticationInformation
    ...
    def hash
      [authentication_result, authentication_status_msg, cavv, cavv_algorithm, indicator, eci, eci_raw, pares_status, specification_version, ucaf_authentication_data, ucaf_collection_indicator, xid].hash
    end
