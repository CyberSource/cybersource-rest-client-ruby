...
module CyberSource
  class Tmsv2TokenizedCardMetadataCardArt
    attr_accessor :combined_asset

    attr_accessor :brand_logo_asset

    attr_accessor :co_brand_logo_asset

    attr_accessor :issuer_logo_asset
    ...
    attr_accessor :background_asset
    ...
    def self.json_map
      {
        ...
        :'co_brand_logo_asset' => :'co_brand_logo_asset',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'brandLogoAsset')
        self.brand_logo_asset = attributes[:'brandLogoAsset']
      end

      if attributes.has_key?(:'coBrandLogoAsset')
        self.co_brand_logo_asset = attributes[:'coBrandLogoAsset']
      end

      if attributes.has_key?(:'issuerLogoAsset')
        self.issuer_logo_asset = attributes[:'issuerLogoAsset']
      end

      if attributes.has_key?(:'iconAsset')
        self.icon_asset = attributes[:'iconAsset']
      end
      ...
      if attributes.has_key?(:'backgroundAsset')
        self.background_asset = attributes[:'backgroundAsset']
      end
    end
    ...
    def hash
      [combined_asset, brand_logo_asset, co_brand_logo_asset, issuer_logo_asset, icon_asset, foreground_color, background_asset].hash
    end
