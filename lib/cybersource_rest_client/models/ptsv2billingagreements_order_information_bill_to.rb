...
module CyberSource
  class Ptsv2billingagreementsOrderInformationBillTo
    ...
    def hash
      [address1, address2, administrative_area, building_number, company, country, county, district, email, first_name, middle_name, last_name, locality, phone_number, postal_code, title].hash
    end
