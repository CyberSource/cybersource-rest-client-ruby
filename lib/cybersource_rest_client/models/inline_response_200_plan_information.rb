...
module CyberSource
  class InlineResponse200PlanInformation
    # Plan code 
    attr_accessor :code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billingCycles')
        self.billing_cycles = attributes[:'billingCycles']
      end
    end
    ...
    def hash
      [code, status, name, description, billing_period, billing_cycles].hash
    end
