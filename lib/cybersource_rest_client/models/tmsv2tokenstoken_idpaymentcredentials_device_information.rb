...
module CyberSource
  class Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'platformType')
        self.platform_type = attributes[:'platformType']
      end
    ...
    def list_invalid_properties
      ...
      #if !@ip_address.nil? && @ip_address !~ Regexp.new(/[0-9A-Fa-f.]/)
        #invalid_properties.push('invalid value for "ip_address", must conform to the pattern /[0-9A-Fa-f.]/.')
      #end

      #if !@http_accept_content.nil? && @http_accept_content !~ Regexp.new(/[A-Za-z0-9]+/)
        #invalid_properties.push('invalid value for "http_accept_content", must conform to the pattern /[A-Za-z0-9]+/.')
      #end

      #if !@http_browser_language.nil? && @http_browser_language !~ Regexp.new(/[A-Za-z0-9]+/)
        #invalid_properties.push('invalid value for "http_browser_language", must conform to the pattern /[A-Za-z0-9]+/.')
      #end

      #if !@http_browser_color_depth.nil? && @http_browser_color_depth !~ Regexp.new(/[0-9]+/)
        #invalid_properties.push('invalid value for "http_browser_color_depth", must conform to the pattern /[0-9]+/.')
      #end

      #if !@http_browser_screen_height.nil? && @http_browser_screen_height !~ Regexp.new(/[0-9]+/)
        #invalid_properties.push('invalid value for "http_browser_screen_height", must conform to the pattern /[0-9]+/.')
      #end

      #if !@http_browser_screen_width.nil? && @http_browser_screen_width !~ Regexp.new(/[0-9]+/)
        #invalid_properties.push('invalid value for "http_browser_screen_width", must conform to the pattern /[0-9]+/.')
      #end

      #if !@http_browser_time_difference.nil? && @http_browser_time_difference !~ Regexp.new(/[0-9]+/)
        #invalid_properties.push('invalid value for "http_browser_time_difference", must conform to the pattern /[0-9]+/.')
      #end

      #if !@user_agent_browser_value.nil? && @user_agent_browser_value !~ Regexp.new(/[A-Za-z0-9]+/)
        #invalid_properties.push('invalid value for "user_agent_browser_value", must conform to the pattern /[A-Za-z0-9]+/.')
      #end
    ...
    def valid?
      #return false if !@ip_address.nil? && @ip_address !~ Regexp.new(/[0-9A-Fa-f.]/)
      #return false if !@http_accept_content.nil? && @http_accept_content !~ Regexp.new(/[A-Za-z0-9]+/)
      #return false if !@http_browser_language.nil? && @http_browser_language !~ Regexp.new(/[A-Za-z0-9]+/)
      #return false if !@http_browser_color_depth.nil? && @http_browser_color_depth !~ Regexp.new(/[0-9]+/)
      #return false if !@http_browser_screen_height.nil? && @http_browser_screen_height !~ Regexp.new(/[0-9]+/)
      #return false if !@http_browser_screen_width.nil? && @http_browser_screen_width !~ Regexp.new(/[0-9]+/)
      #return false if !@http_browser_time_difference.nil? && @http_browser_time_difference !~ Regexp.new(/[0-9]+/)
      #return false if !@user_agent_browser_value.nil? && @user_agent_browser_value !~ Regexp.new(/[A-Za-z0-9]+/)
      true
    end
    ...
    def ip_address=(ip_address)
      #if !ip_address.nil? && ip_address !~ Regexp.new(/[0-9A-Fa-f.]/)
        #fail ArgumentError, 'invalid value for "ip_address", must conform to the pattern /[0-9A-Fa-f.]/.'
      #end
    ...
    def http_accept_content=(http_accept_content)
      #if !http_accept_content.nil? && http_accept_content !~ Regexp.new(/[A-Za-z0-9]+/)
        #fail ArgumentError, 'invalid value for "http_accept_content", must conform to the pattern /[A-Za-z0-9]+/.'
      #end
    ...
    def http_browser_language=(http_browser_language)
      #if !http_browser_language.nil? && http_browser_language !~ Regexp.new(/[A-Za-z0-9]+/)
        #fail ArgumentError, 'invalid value for "http_browser_language", must conform to the pattern /[A-Za-z0-9]+/.'
      #end
    ...
    def http_browser_color_depth=(http_browser_color_depth)
      #if !http_browser_color_depth.nil? && http_browser_color_depth !~ Regexp.new(/[0-9]+/)
        #fail ArgumentError, 'invalid value for "http_browser_color_depth", must conform to the pattern /[0-9]+/.'
      #end
    ...
    def http_browser_screen_height=(http_browser_screen_height)
      #if !http_browser_screen_height.nil? && http_browser_screen_height !~ Regexp.new(/[0-9]+/)
        #fail ArgumentError, 'invalid value for "http_browser_screen_height", must conform to the pattern /[0-9]+/.'
      #end
    ...
    def http_browser_screen_width=(http_browser_screen_width)
      #if !http_browser_screen_width.nil? && http_browser_screen_width !~ Regexp.new(/[0-9]+/)
        #fail ArgumentError, 'invalid value for "http_browser_screen_width", must conform to the pattern /[0-9]+/.'
      #end
    ...
    def http_browser_time_difference=(http_browser_time_difference)
      #if !http_browser_time_difference.nil? && http_browser_time_difference !~ Regexp.new(/[0-9]+/)
        #fail ArgumentError, 'invalid value for "http_browser_time_difference", must conform to the pattern /[0-9]+/.'
      #end
    ...
    def user_agent_browser_value=(user_agent_browser_value)
      #if !user_agent_browser_value.nil? && user_agent_browser_value !~ Regexp.new(/[A-Za-z0-9]+/)
        #fail ArgumentError, 'invalid value for "user_agent_browser_value", must conform to the pattern /[A-Za-z0-9]+/.'
      #end
    ...
    def hash
      [platform_type, ip_address, http_accept_content, http_browser_language, http_browser_java_enabled, http_browser_java_script_enabled, http_browser_color_depth, http_browser_screen_height, http_browser_screen_width, http_browser_time_difference, user_agent_browser_value].hash
    end
