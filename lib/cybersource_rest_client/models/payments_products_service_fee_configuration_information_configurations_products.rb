...
module CyberSource
  class PaymentsProductsServiceFeeConfigurationInformationConfigurationsProducts
    ...
    attr_accessor :service_fee_enabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceFeeEnabled')
        self.service_fee_enabled = attributes[:'serviceFeeEnabled']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          service_fee_enabled == o.service_fee_enabled
    end
