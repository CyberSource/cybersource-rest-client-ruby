...
module CyberSource
  class PtsV2CreateOrderPost201Response
    ...
    def hash
      [submit_time_utc, update_time_utc, status, reconciliation_id, client_reference_information, processor_information, payment_information, buyer_information].hash
    end
