...
module CyberSource
  class UnderwritingConfigurationBillingInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankAccountInformation')
        self.bank_account_information = attributes[:'bankAccountInformation']
      end
    end
