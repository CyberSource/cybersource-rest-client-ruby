...
module CyberSource
  class InlineResponse2018OrderInformationCurrencyConversion
    ...
    def self.swagger_types
      {
        ...
        :'offer' => :'Array<InlineResponse2018OrderInformationCurrencyConversionOffer>',
        :'disclaimer' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'offer')
        if (value = attributes[:'offer']).is_a?(Array)
          self.offer = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @reconciliation_id.nil?
        invalid_properties.push('invalid value for "reconciliation_id", reconciliation_id cannot be nil.')
      end
    ...
    def valid?
      return false if @reconciliation_id.nil?
      true
    end
    ...
    def reconciliation_id=(reconciliation_id)
      #if reconciliation_id.nil?
        #fail ArgumentError, 'reconciliation_id cannot be nil'
      #end
    ...
    # Custom attribute writer method with validation
    # @param [Object] disclaimer Value to be assigned
    ...
    def hash
      [type, reconciliation_id, offer, disclaimer].hash
    end
