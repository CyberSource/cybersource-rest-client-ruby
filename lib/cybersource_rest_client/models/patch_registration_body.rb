...
module CyberSource
  class PatchRegistrationBody
    ...
    def list_invalid_properties
      ...
      if @organization_information.nil?
        invalid_properties.push('invalid value for "organization_information", organization_information cannot be nil.')
      end
    ...
    def valid?
      return false if @organization_information.nil?
      true
    end
    ...
    def hash
      [registration_information, integration_information, organization_information, product_information, document_information].hash
    end
