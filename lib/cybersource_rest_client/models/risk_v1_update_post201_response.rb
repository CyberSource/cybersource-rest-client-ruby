...
module CyberSource
  class RiskV1UpdatePost201Response
    ...
    def self.json_map
      {
        :'_links' => :'_links',
        :'client_reference_informaton' => :'client_reference_informaton',
        :'id' => :'id',
        :'status' => :'status',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clientReferenceInformaton')
        self.client_reference_informaton = attributes[:'clientReferenceInformaton']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _links == o._links &&
          client_reference_informaton == o.client_reference_informaton &&
          id == o.id &&
          status == o.status &&
    ...
    def hash
      [_links, client_reference_informaton, id, status, submit_time_utc].hash
    end
