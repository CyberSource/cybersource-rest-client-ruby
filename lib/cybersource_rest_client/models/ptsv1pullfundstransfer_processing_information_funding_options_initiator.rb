...
module CyberSource
  class Ptsv1pullfundstransferProcessingInformationFundingOptionsInitiator
    ...
    def self.json_map
      {
        :'originator_initiated_transaction' => :'originator_initiated_transaction',
        :'type' => :'type',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'originatorInitiatedTransaction')
        self.originator_initiated_transaction = attributes[:'originatorInitiatedTransaction']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          originator_initiated_transaction == o.originator_initiated_transaction &&
          type == o.type &&
    ...
    def hash
      [originator_initiated_transaction, type, stored_credential_used, credential_stored_on_file].hash
    end
