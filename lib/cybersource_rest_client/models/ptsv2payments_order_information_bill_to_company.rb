...
module CyberSource
  class Ptsv2paymentsOrderInformationBillToCompany
    ...
    def list_invalid_properties
      ...
      if !@address2.nil? && @address2.to_s.length > 40
        invalid_properties.push('invalid value for "address2", the character length must be smaller than or equal to 40.')
      end

      if !@locality.nil? && @locality.to_s.length > 30
        invalid_properties.push('invalid value for "locality", the character length must be smaller than or equal to 30.')
      end
    ...
    def valid?
      ...
      return false if !@address2.nil? && @address2.to_s.length > 40
      return false if !@locality.nil? && @locality.to_s.length > 30
    ...
    def address2=(address2)
      if !address2.nil? && address2.to_s.length > 40
        fail ArgumentError, 'invalid value for "address2", the character length must be smaller than or equal to 40.'
      end
    ...
    def locality=(locality)
      if !locality.nil? && locality.to_s.length > 30
        fail ArgumentError, 'invalid value for "locality", the character length must be smaller than or equal to 30.'
      end
