  ...
  class Rbsv1plansOrderInformationAmountDetails
    ...
    def list_invalid_properties
      ...
      if @billing_amount.nil?
        invalid_properties.push('invalid value for "billing_amount", billing_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @billing_amount.nil?
      true
    end
    ...
    def hash
      [currency, billing_amount, setup_fee].hash
    end
