...
module CyberSource
  class Boardingv1registrationsProductInformationSelectedProductsPaymentsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent
    ...
    attr_accessor :enable_terminal_id_lookup
    ...
    def self.json_map
      {
        :'processors' => :'processors',
        :'enable_terminal_id_lookup' => :'enable_terminal_id_lookup'
      }
    end
    ...
    def self.swagger_types
      {
        ...
        :'enable_terminal_id_lookup' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'enableTerminalIdLookup')
        self.enable_terminal_id_lookup = attributes[:'enableTerminalIdLookup']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_terminal_id_lookup == o.enable_terminal_id_lookup
    end
    ...
    def hash
      [processors, enable_terminal_id_lookup].hash
    end
