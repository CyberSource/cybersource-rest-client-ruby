...
module CyberSource
  class InlineResponse2017EmbeddedPointOfSaleInformationPartner
    ...
    def list_invalid_properties
      ...
      if !@original_transaction_id.nil? && @original_transaction_id.to_s.length > 50
        invalid_properties.push('invalid value for "original_transaction_id", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      return false if !@original_transaction_id.nil? && @original_transaction_id.to_s.length > 50
      true
    end
    ...
    def original_transaction_id=(original_transaction_id)
      if !original_transaction_id.nil? && original_transaction_id.to_s.length > 50
        fail ArgumentError, 'invalid value for "original_transaction_id", the character length must be smaller than or equal to 50.'
      end
