  ...
  class RetrievalDetailsApi
    ...
    def get_retrieval_details_with_http_info(start_time, end_time, opts = {})
      ...
      if @api_client.config.client_side_validation && start_time.nil?
        fail ArgumentError, "Missing the required parameter 'start_time' when calling RetrievalDetailsApi.get_retrieval_details"
      end
      ...
      # resource path
      local_var_path = 'reporting/v3/retrieval-details'
