...
module CyberSource
  class CustomerApi
    ...
    def patch_customer_with_http_info(customer_id, patch_customer_request, opts = {})
      ...
      post_body = sdk_tracker.insert_developer_id_tracker(post_body, 'PatchCustomerRequest', @api_client.config.host)
      auth_names = []
    ...
    def post_customer_with_http_info(post_customer_request, opts = {})
      ...
      sdk_tracker = SdkTracker.new
      post_body = sdk_tracker.insert_developer_id_tracker(post_body, 'PostCustomerRequest', @api_client.config.host)
      auth_names = []
