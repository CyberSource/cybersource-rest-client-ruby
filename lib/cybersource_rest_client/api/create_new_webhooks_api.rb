...
module CyberSource
  class CreateNewWebhooksApi
    ...
    def notification_subscriptions_v1_products_organization_id_get(organization_id, opts = {})
      data, status_code, headers = notification_subscriptions_v1_products_organization_id_get_with_http_info(organization_id, opts)
    ...
    def notification_subscriptions_v1_products_organization_id_get_with_http_info(organization_id, opts = {})

      if @api_client.config.debugging
          begin
            raise
                @api_client.config.logger.debug 'Calling API: CreateNewWebhooksApi.notification_subscriptions_v1_products_organization_id_get ...'
            rescue
      ...
      if @api_client.config.client_side_validation && organization_id.nil?
        fail ArgumentError, "Missing the required parameter 'organization_id' when calling CreateNewWebhooksApi.notification_subscriptions_v1_products_organization_id_get"
      end
      # resource path
      ...
      if @api_client.config.debugging
        begin
        raise
            @api_client.config.logger.debug "API called: CreateNewWebhooksApi#notification_subscriptions_v1_products_organization_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
        rescue
            puts 'Cannot write to log'
        end
      end
    ...
    #
    # DISCLAIMER: Cybersource may allow Customer to access, use, and/or test a Cybersource product or service that may still be in development or has not been market-tested (“Beta Product”) solely for the purpose of evaluating the functionality or marketability of the Beta Product (a “Beta Evaluation”). Notwithstanding any language to the contrary, the following terms shall apply with respect to Customer’s participation in any Beta Evaluation (and the Beta Product(s)) accessed thereunder): The Parties will enter into a separate form agreement detailing the scope of the Beta Evaluation, requirements, pricing, the length of the beta evaluation period (“Beta Product Form”). Beta Products are not, and may not become, Transaction Services and have not yet been publicly released and are offered for the sole purpose of internal testing and non-commercial evaluation. Customer’s use of the Beta Product shall be solely for the purpose of conducting the Beta Evaluation. Customer accepts all risks arising out of the access and use of the Beta Products. Cybersource may, in its sole discretion, at any time, terminate or discontinue the Beta Evaluation. Customer acknowledges and agrees that any Beta Product may still be in development and that Beta Product is provided “AS IS” and may not perform at the level of a commercially available service, may not operate as expected and may be modified prior to release. CYBERSOURCE SHALL NOT BE RESPONSIBLE OR LIABLE UNDER ANY CONTRACT, TORT (INCLUDING NEGLIGENCE), OR OTHERWISE RELATING TO A BETA PRODUCT OR THE BETA EVALUATION (A) FOR LOSS OR INACCURACY OF DATA OR COST OF PROCUREMENT OF SUBSTITUTE GOODS, SERVICES OR TECHNOLOGY, (B) ANY CLAIM, LOSSES, DAMAGES, OR CAUSE OF ACTION ARISING IN CONNECTION WITH THE BETA PRODUCT; OR (C) FOR ANY INDIRECT, INCIDENTAL OR CONSEQUENTIAL DAMAGES INCLUDING, BUT NOT LIMITED TO, LOSS OF REVENUES AND LOSS OF PROFITS.
    def notification_subscriptions_v1_webhooks_post(opts = {})
      data, status_code, headers = notification_subscriptions_v1_webhooks_post_with_http_info(opts)
      return data, status_code, headers
    end
    ...
    def notification_subscriptions_v1_webhooks_post_with_http_info(opts = {})

      if @api_client.config.debugging
          begin
            raise
                @api_client.config.logger.debug 'Calling API: CreateNewWebhooksApi.notification_subscriptions_v1_webhooks_post ...'
            rescue
                puts 'Cannot write to log'
            end
      end
      ...
      if @api_client.config.debugging
        begin
        raise
            @api_client.config.logger.debug "API called: CreateNewWebhooksApi#notification_subscriptions_v1_webhooks_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
        rescue
            puts 'Cannot write to log'
        end
      end
    ...
    def save_sym_egress_key_with_http_info(v_c_sender_organization_id, v_c_permissions, opts = {})
      ...
      if @api_client.config.client_side_validation && v_c_sender_organization_id.to_s.length > 100
        fail ArgumentError, 'invalid value for "v_c_sender_organization_id" when calling CreateNewWebhooksApi.save_sym_egress_key, the character length must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && v_c_sender_organization_id.to_s.length < 2
        fail ArgumentError, 'invalid value for "v_c_sender_organization_id" when calling CreateNewWebhooksApi.save_sym_egress_key, the character length must be great than or equal to 2.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'v_c_correlation_id'].nil? && opts[:'v_c_correlation_id'].to_s.length > 100
        fail ArgumentError, 'invalid value for "opts[:"v_c_correlation_id"]" when calling CreateNewWebhooksApi.save_sym_egress_key, the character length must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'v_c_correlation_id'].nil? && opts[:'v_c_correlation_id'].to_s.length < 2
        fail ArgumentError, 'invalid value for "opts[:"v_c_correlation_id"]" when calling CreateNewWebhooksApi.save_sym_egress_key, the character length must be great than or equal to 2.'
      end
