...
module CyberSource
  class InlineResponse2004OrderInformationInvoiceDetails
    ...
    def hash
      [purchase_order_number, purchase_order_date, taxable, vat_invoice_reference_number, commodity_code, transaction_advice_addendum, level3_transmission_status].hash
    end
