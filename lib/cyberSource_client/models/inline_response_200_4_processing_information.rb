...
module CyberSource
  class InlineResponse2004ProcessingInformation
    ...
    def self.swagger_types
      {
        ...
        :'authorization_options' => :'InlineResponse2004ProcessingInformationAuthorizationOptions'
      }
    end
    ...
    def hash
      [payment_solution, authorization_options].hash
    end
