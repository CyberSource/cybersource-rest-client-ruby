...
module CyberSource
  class InlineResponse2004
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['PENDING', 'TRANSMITTED', 'BATCH_ERROR', 'VOIDED'])
    ...
    def hash
      [_links, id, submit_time_utc, status, reconciliation_id, client_reference_information, processing_information, processor_information, order_information, buyer_information, merchant_information, device_information].hash
    end
