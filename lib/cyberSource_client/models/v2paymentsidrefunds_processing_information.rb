...
module CyberSource
  class V2paymentsidrefundsProcessingInformation
    ...
    def hash
      [payment_solution, reconciliation_id, link_id, report_group, visa_checkout_id, purchase_level, recurring_options].hash
    end
