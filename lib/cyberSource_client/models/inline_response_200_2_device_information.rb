...
module CyberSource
  class InlineResponse2002DeviceInformation
    # TBD
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fingerprintId')
        self.fingerprint_id = attributes[:'fingerprintId']
      end
    ...
    def hash
      [id, fingerprint_id, ip_address].hash
    end
