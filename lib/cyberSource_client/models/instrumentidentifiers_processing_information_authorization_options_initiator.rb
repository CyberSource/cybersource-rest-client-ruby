...
module CyberSource
  class InstrumentidentifiersProcessingInformationAuthorizationOptionsInitiator
    ...
    def self.swagger_types
      {
        :'merchant_initiated_transaction' => :'InstrumentidentifiersProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction'
      }
    end
