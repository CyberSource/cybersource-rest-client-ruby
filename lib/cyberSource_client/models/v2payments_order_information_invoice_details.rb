...
module CyberSource
  class V2paymentsOrderInformationInvoiceDetails
    ...
    def hash
      [purchase_order_number, purchase_order_date, purchase_contact_name, taxable, vat_invoice_reference_number, commodity_code, merchandise_code, transaction_advice_addendum].hash
    end
