...
module CyberSource
  class InlineResponse2004OrderInformationAmountDetails
    ...
    def hash
      [total_amount, currency, discount_amount, duty_amount, tax_amount, national_tax_included, freight_amount, tax_details].hash
    end
