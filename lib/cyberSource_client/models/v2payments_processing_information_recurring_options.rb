...
module CyberSource
  class V2paymentsProcessingInformationRecurringOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loanPayment')
        self.loan_payment = attributes[:'loanPayment']
      else
        self.loan_payment = false
      end
    ...
    def hash
      [loan_payment, first_recurring_payment].hash
    end
