...
**provider_transaction_id** | **String** | Unique ID [codigo] generated by the processor for real-time payments processed directly by the Iugu processor. | [optional] 
...
**event_status** | **String** | The event status.  | [optional] 
