...
**handler_id** | **String** | Payment handler or processor identifier (e.g. &#x60;visa&#x60;). | [optional] 
**handler_name** | **String** | Human-readable name of the payment handler. | [optional] 
**brand** | **String** | Card brand (e.g. &#x60;visa&#x60;, &#x60;mastercard&#x60;). | [optional] 
**last_digits** | **String** | Last 4 digits of the card number for display purposes. | [optional] 
