# CyberSource::PblPaymentLinksPost201ResponsePurchaseInformation
...
**expiration_amount** | **String** | Define an expiry amount for the link.  Must be null or greater than 0.  If the total price of all transactions for this link exceeds the expiry amount, the link will expire.  | [optional] 
**expiration_quantity** | **String** | Define an expiration quantity for the link.  Must be null or greater than 0.  If the total quantity of items sold exceeds the expiration quantity, the link is expired.  | [optional] 
