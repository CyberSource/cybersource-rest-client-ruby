# CyberSource::InlineResponse20111OrderInformationCurrencyConversion
...
**reconciliation_id** | **String** | Unique identifier generated by the DCC provider. | 
**offer** | [**Array&lt;InlineResponse20111OrderInformationCurrencyConversionOffer&gt;**](InlineResponse20111OrderInformationCurrencyConversionOffer.md) | When type is DCC this is a single item. When type is MCP this is an array that repeats for each currency that&#39;s configured by the currency conversion provider for the merchant.  | [optional] 
