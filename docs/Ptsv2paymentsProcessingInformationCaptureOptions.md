...
**date_to_capture** | **String** | Date on which you want the capture to occur. This field is supported only for CyberSource through VisaNet. Format: &#x60;MMDD&#x60;  #### Used by **Authorization** Optional field.  | [optional] 
...
**reconciliation_id** | **String** | Used for authbill request when capture field equals true | [optional] 
