# CyberSource::Ptsv2payoutstransactionqueryidClientReferenceInformation
...
**application_name** | **String** | The name of the Connection Method that the originator uses to send a transaction request to CyberSource.  | [optional] 
