...
**location_id** | **String** | The agency code, address, phone number, etc., used to identify the location where the vehicle was rented.  | [optional] 
...
**postal_code** | **String** | When merchant wants to send the rental address&#39;s postal code.  | [optional] 
