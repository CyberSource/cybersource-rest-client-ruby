...
**raw_response** | **String** | Failure reason returned by the processor. | [optional] 
**raw_response_local** | **String** | Failure reason returned by the processor in the local language of the processor. | [optional] 
