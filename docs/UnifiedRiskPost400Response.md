...
**errors** | [**Array&lt;UnifiedRiskPost400ResponseErrors&gt;**](UnifiedRiskPost400ResponseErrors.md) | Root-level list of action-level errors describing what failed and why. | 
