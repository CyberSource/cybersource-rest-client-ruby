...
**commerce_indicator** | **String** | Type of transaction. Possible value for Fast Payments transactions:   - internet  | [optional] 
...
**payouts_options** | [**V2payoutsProcessingInformationPayoutsOptions**](V2payoutsProcessingInformationPayoutsOptions.md) |  | [optional] 
