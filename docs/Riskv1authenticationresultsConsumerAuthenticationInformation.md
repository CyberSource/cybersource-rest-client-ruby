...
**authentication_transaction_context** | **String** | Authentication transaction context is used as a unique identifier to link enroll and validate call.  | [optional] 
**otp_token** | **String** | OTP entered by the card holder.  | [optional] 
**response_access_token** | **String** | JWT returned by the 3D Secure provider when the authentication is complete. Required for Hybrid integration if you use the Cybersource-generated access token. Note: Max. length of this field is 2048 characters.  | [optional] 
...
**credential_encrypted** | **String** | A flag to indicate if the passed credential has been encrypted by the Merchant. | [optional] 
