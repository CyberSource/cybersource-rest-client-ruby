# CyberSource::MerchantInitiatedTransactionObject
...
**original_authorized_amount** | **String** | Amount of the original authorization.  This field is supported only for Apple Pay, Google Pay, and Samsung Pay transactions with Discover on FDC Nashville Global and Chase Paymentech.  | [optional] 
**agreement_id** | **String** | This field contains the predetermined agrement id with the merchant  | [optional] 
