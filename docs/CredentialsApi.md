...
api_instance = CyberSource::CredentialsApi.new

mpp_credentials_request = CyberSource::MppCredentialsRequest.new # MppCredentialsRequest | 


begin
  #Provision MPP credentials
  result = api_instance.provision_mpp_credentials(mpp_credentials_request)
  p result
rescue CyberSource::ApiError => e
  puts "Exception when calling CredentialsApi->provision_mpp_credentials: #{e}"
end
```
