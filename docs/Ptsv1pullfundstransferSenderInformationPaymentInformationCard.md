...
**expiration_month** | **String** | Two-digit month in which the payment card expires.  Format: &#x60;MM&#x60;.  Valid values: &#x60;01&#x60; through &#x60;12&#x60;. Leading 0 is required.   Conditional: this field is required if using neither a Customer nor Payment Instrument token.  | [optional] 
**expiration_year** | **String** | Four-digit year in which the payment card expires.  Format: &#x60;YYYY&#x60;.  Conditional: this field is required if using neither a Customer nor Payment Instrument token.  | [optional] 
