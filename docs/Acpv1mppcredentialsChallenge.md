...
**accepted_networks** | **Array&lt;String&gt;** | Card networks accepted by the merchant (e.g., [&#39;visa&#39;, &#39;mastercard&#39;]). | 
**merchant_id** | **String** | Merchant identifier (maps to &#39;recipient&#39; in MPP spec request object). | 
**merchant_name** | **String** | Human-readable merchant name. | 
