...
------------ | ------------- | ------------- | -------------
**extension_days** | **String** | Request field for merchant to increase the AUTH expiry days for Klarna Advantage Plus. Applicable for Re-Authorization (AP_REAUTH) service.  | [optional] 
