...
**personal_id_type** | **String** | This field denotes whether the Tax ID is a business or individual&#39;s Tax ID when idType contains the value of TXIN (Tax identification).  The valid values are: B (Business) I (Individual)  | [optional] 
