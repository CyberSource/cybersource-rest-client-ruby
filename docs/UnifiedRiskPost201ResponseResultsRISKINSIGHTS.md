...
------------ | ------------- | ------------- | -------------
**request_id** | **String** | Echoes the unique request identifier submitted in the original VPRI request, enabling clients to correlate responses with their outbound calls. | 
**response_timestamp** | **DateTime** | ISO 8601 timestamp indicating when the VPRI response was generated by the service. | 
**processing_time_ms** | **Integer** | Server-side processing time in milliseconds from request receipt to response dispatch. Useful for latency monitoring and SLA tracking. May be null if processing time was not recorded. | [optional] 
