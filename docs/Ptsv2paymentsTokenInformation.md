...
**client_correlation_id** | **String** | Client-generated unique identifier for correlating token operations across API calls. This value helps track and associate token-related transactions.  | [optional] 
**token_authentication_information** | [**Ptsv2paymentsTokenInformationTokenAuthenticationInformation**](Ptsv2paymentsTokenInformationTokenAuthenticationInformation.md) |  | [optional] 
