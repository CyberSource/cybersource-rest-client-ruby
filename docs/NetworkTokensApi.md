...
api_instance = CyberSource::NetworkTokensApi.new
...
begin
  ...
  puts "Exception when calling NetworkTokensApi->get_card_art_asset: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkTokensApi->get_tokenized_card: #{e}"
end
```
...
post_issuer_life_cycle_simulation_request = CyberSource::PostIssuerLifeCycleSimulationRequest.new # PostIssuerLifeCycleSimulationRequest | 
...
begin
  ...
  puts "Exception when calling NetworkTokensApi->post_issuer_life_cycle_simulation: #{e}"
end
```
...
post_payment_credentials_request = CyberSource::PostPaymentCredentialsRequest1.new # PostPaymentCredentialsRequest1 | 
...
begin
  ...
  puts "Exception when calling NetworkTokensApi->post_token_payment_credentials: #{e}"
end
```
...
> InlineResponse2011 post_token_payment_credentials_v3(token_id, post_payment_credentials_request, opts)
...
begin
  #Generate Payment Credentials Latest Version v3
  result = api_instance.post_token_payment_credentials_v3(token_id, post_payment_credentials_request, opts)
  p result
rescue CyberSource::ApiError => e
  puts "Exception when calling NetworkTokensApi->post_token_payment_credentials_v3: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkTokensApi->post_tokenized_card: #{e}"
end
```
...
> post_tokenized_card_delete(tokenized_card_id, opts)
...
begin
  #Delete a Tokenized Card
  api_instance.post_tokenized_card_delete(tokenized_card_id, opts)
rescue CyberSource::ApiError => e
  puts "Exception when calling NetworkTokensApi->post_tokenized_card_delete: #{e}"
end
```
