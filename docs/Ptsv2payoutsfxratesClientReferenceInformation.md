...
------------ | ------------- | ------------- | -------------
**application_name** | **String** | The name of the Connection Method client (such as Virtual Terminal, Batch Upload, etc.) that submitted the payment transaction request to CyberSource.  | [optional] 
