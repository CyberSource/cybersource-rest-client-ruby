...
mv ../lib/cybersource_rest_client/models/acpv1instructionsinstruction_idconfirmations_processor_information_payment_instrument_verification_results.rb ../lib/cybersource_rest_client/models/acpv1instructionsinstruction_idconf_processor_info_payment_instrument_verifi_results.rb
sed -i "s|cybersource_rest_client/models/acpv1instructionsinstruction_idconfirmations_processor_information_payment_instrument_verification_results|cybersource_rest_client/models/acpv1instructionsinstruction_idconf_processor_info_payment_instrument_verifi_results|g" ../lib/cybersource_rest_client.rb

mv ../lib/cybersource_rest_client/models/payments_products_unified_checkout_subscription_information_features_portfolio_accessof_sensitive_data.rb ../lib/cybersource_rest_client/models/payments_products_unified_checkout_subscription_info_features_portfolio_accessof_sensi_data.rb
sed -i "s|cybersource_rest_client/models/payments_products_unified_checkout_subscription_information_features_portfolio_accessof_sensitive_data|cybersource_rest_client/models/payments_products_unified_checkout_subscription_info_features_portfolio_accessof_sensi_data|g" ../lib/cybersource_rest_client.rb

mv ../lib/cybersource_rest_client/models/ptsv1pullfundstransfer_processing_information_funding_options_initiator_originator_initiated_transaction.rb ../lib/cybersource_rest_client/models/ptsv1pullfundstransfer_processing_info_funding_options_initiator_origin_ini_transaction.rb
sed -i "s|cybersource_rest_client/models/ptsv1pullfundstransfer_processing_information_funding_options_initiator_originator_initiated_transaction|cybersource_rest_client/models/ptsv1pullfundstransfer_processing_info_funding_options_initiator_origin_ini_transaction|g" ../lib/cybersource_rest_client.rb

mv ../lib/cybersource_rest_client/models/unified_risk_post201_response_results_risk_insights_packages_transaction_insights_insights_warnings.rb ../lib/cybersource_rest_client/models/unified_risk_post201_response_transaction_insights_insights_warnings.rb
sed -i "s|cybersource_rest_client/models/unified_risk_post201_response_results_risk_insights_packages_transaction_insights_insights_warnings|cybersource_rest_client/models/unified_risk_post201_response_transaction_insights_insights_warnings|g" ../lib/cybersource_rest_client.rb
