...
# Unit tests for CyberSource::RequestBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestBody1' do
  before do
    # run before each test
    @instance = CyberSource::RequestBody1.new
  end
  ...
  describe 'test an instance of RequestBody1' do
    it 'should create an instance of RequestBody1' do
      expect(@instance).to be_instance_of(CyberSource::RequestBody1)
    end
  end
