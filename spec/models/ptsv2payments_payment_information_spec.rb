...
# Unit tests for CyberSource::Ptsv2paymentsPaymentInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ptsv2paymentsPaymentInformation' do
  before do
    # run before each test
    @instance = CyberSource::Ptsv2paymentsPaymentInformation.new
  end
  ...
  describe 'test an instance of Ptsv2paymentsPaymentInformation' do
    it 'should create an instance of Ptsv2paymentsPaymentInformation' do
