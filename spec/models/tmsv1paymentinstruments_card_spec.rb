...
# Unit tests for CyberSource::Tmsv1paymentinstrumentsCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Tmsv1paymentinstrumentsCard' do
  before do
    # run before each test
    @instance = CyberSource::Tmsv1paymentinstrumentsCard.new
  end
  ...
  describe 'test an instance of Tmsv1paymentinstrumentsCard' do
    it 'should create an instance of Tmsv1paymentinstrumentsCard' do
      expect(@instance).to be_instance_of(CyberSource::Tmsv1paymentinstrumentsCard)
    end
  end
