...
# Unit tests for CyberSource::Ptsv1pullfundstransferSenderInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ptsv1pullfundstransferSenderInformation' do
  before do
    # run before each test
    @instance = CyberSource::Ptsv1pullfundstransferSenderInformation.new
  end
  ...
  describe 'test an instance of Ptsv1pullfundstransferSenderInformation' do
    it 'should create an instance of Ptsv1pullfundstransferSenderInformation' do
      expect(@instance).to be_instance_of(CyberSource::Ptsv1pullfundstransferSenderInformation)
    end
  end
