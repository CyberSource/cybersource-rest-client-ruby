...
# Unit tests for CyberSource::TmsV1PaymentinstrumentsPost201ResponseCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TmsV1PaymentinstrumentsPost201ResponseCard' do
  before do
    # run before each test
    @instance = CyberSource::TmsV1PaymentinstrumentsPost201ResponseCard.new
  end
  ...
  describe 'test an instance of TmsV1PaymentinstrumentsPost201ResponseCard' do
    it 'should create an instance of TmsV1PaymentinstrumentsPost201ResponseCard' do
      expect(@instance).to be_instance_of(CyberSource::TmsV1PaymentinstrumentsPost201ResponseCard)
    end
  end
