...
# Unit tests for CyberSource::InlineResponse4045
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse4045' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse4045.new
  end
  ...
  describe 'test an instance of InlineResponse4045' do
    it 'should create an instance of InlineResponse4045' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse4045)
    end
  end
