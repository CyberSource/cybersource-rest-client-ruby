...
# Unit tests for CyberSource::TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard' do
  before do
    # run before each test
    @instance = CyberSource::TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard.new
  end
  ...
  describe 'test an instance of TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard' do
    it 'should create an instance of TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard' do
      expect(@instance).to be_instance_of(CyberSource::TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard)
    end
  end
