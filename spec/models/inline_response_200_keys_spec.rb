...
# Unit tests for CyberSource::InlineResponse200Keys
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Keys' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse200Keys.new
  end
  ...
  describe 'test an instance of InlineResponse200Keys' do
    it 'should create an instance of InlineResponse200Keys' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse200Keys)
    end
  end
