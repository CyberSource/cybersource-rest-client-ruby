...
# Unit tests for CyberSource::PaymentinstrumentsCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentinstrumentsCard' do
  before do
    # run before each test
    @instance = CyberSource::PaymentinstrumentsCard.new
  end
  ...
  describe 'test an instance of PaymentinstrumentsCard' do
    it 'should create an instance of PaymentinstrumentsCard' do
      expect(@instance).to be_instance_of(CyberSource::PaymentinstrumentsCard)
    end
  end
