...
# Unit tests for CyberSource::InlineResponseDefault
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponseDefault' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponseDefault.new
  end
  ...
  describe 'test an instance of InlineResponseDefault' do
    it 'should create an instance of InlineResponseDefault' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponseDefault)
    end
  end
