...
# Unit tests for CyberSource::Ucv1sessionsData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ucv1sessionsData' do
  before do
    # run before each test
    @instance = CyberSource::Ucv1sessionsData.new
  end
  ...
  describe 'test an instance of Ucv1sessionsData' do
    it 'should create an instance of Ucv1sessionsData' do
