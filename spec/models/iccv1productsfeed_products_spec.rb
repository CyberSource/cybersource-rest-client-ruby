...
# Unit tests for CyberSource::Iccv1productsfeedProducts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Iccv1productsfeedProducts' do
  before do
    # run before each test
    @instance = CyberSource::Iccv1productsfeedProducts.new
  end
  ...
  describe 'test an instance of Iccv1productsfeedProducts' do
    it 'should create an instance of Iccv1productsfeedProducts' do
      expect(@instance).to be_instance_of(CyberSource::Iccv1productsfeedProducts)
    end
  end
