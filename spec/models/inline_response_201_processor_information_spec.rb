...
# Unit tests for CyberSource::InlineResponse201ProcessorInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse201ProcessorInformation' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse201ProcessorInformation.new
  end
  ...
  describe 'test an instance of InlineResponse201ProcessorInformation' do
    it 'should create an instance of InlineResponse201ProcessorInformation' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse201ProcessorInformation)
    end
  end
