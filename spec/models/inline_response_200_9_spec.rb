...
# Unit tests for CyberSource::InlineResponse2009
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2009' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse2009.new
  end
  ...
  describe 'test an instance of InlineResponse2009' do
    it 'should create an instance of InlineResponse2009' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse2009)
    end
  end
