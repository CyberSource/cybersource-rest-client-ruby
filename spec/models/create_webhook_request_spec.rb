...
# Unit tests for CyberSource::CreateWebhookRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateWebhookRequest' do
  before do
    # run before each test
    @instance = CyberSource::CreateWebhookRequest.new
  end
  ...
  describe 'test an instance of CreateWebhookRequest' do
    it 'should create an instance of CreateWebhookRequest' do
      expect(@instance).to be_instance_of(CyberSource::CreateWebhookRequest)
    end
  end
