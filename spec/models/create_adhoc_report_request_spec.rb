...
# Unit tests for CyberSource::CreateAdhocReportRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAdhocReportRequest' do
  before do
    # run before each test
    @instance = CyberSource::CreateAdhocReportRequest.new
  end
  ...
  describe 'test an instance of CreateAdhocReportRequest' do
    it 'should create an instance of CreateAdhocReportRequest' do
      expect(@instance).to be_instance_of(CyberSource::CreateAdhocReportRequest)
    end
  end
