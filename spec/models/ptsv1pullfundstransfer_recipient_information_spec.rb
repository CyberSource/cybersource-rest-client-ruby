...
# Unit tests for CyberSource::Ptsv1pullfundstransferRecipientInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ptsv1pullfundstransferRecipientInformation' do
  before do
    # run before each test
    @instance = CyberSource::Ptsv1pullfundstransferRecipientInformation.new
  end
  ...
  describe 'test an instance of Ptsv1pullfundstransferRecipientInformation' do
    it 'should create an instance of Ptsv1pullfundstransferRecipientInformation' do
      expect(@instance).to be_instance_of(CyberSource::Ptsv1pullfundstransferRecipientInformation)
    end
  end
