...
# Unit tests for CyberSource::CreatePaymentInstrumentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentInstrumentRequest' do
  before do
    # run before each test
    @instance = CyberSource::CreatePaymentInstrumentRequest.new
  end
  ...
  describe 'test an instance of CreatePaymentInstrumentRequest' do
    it 'should create an instance of CreatePaymentInstrumentRequest' do
      expect(@instance).to be_instance_of(CyberSource::CreatePaymentInstrumentRequest)
    end
  end
