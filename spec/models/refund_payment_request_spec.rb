...
# Unit tests for CyberSource::RefundPaymentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundPaymentRequest' do
  before do
    # run before each test
    @instance = CyberSource::RefundPaymentRequest.new
  end
  ...
  describe 'test an instance of RefundPaymentRequest' do
    it 'should create an instance of RefundPaymentRequest' do
      expect(@instance).to be_instance_of(CyberSource::RefundPaymentRequest)
    end
  end
