...
# Unit tests for CyberSource::InlineResponse2014
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2014' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse2014.new
  end
  ...
  describe 'test an instance of InlineResponse2014' do
    it 'should create an instance of InlineResponse2014' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse2014)
    end
  end
