...
# Unit tests for CyberSource::RefundCaptureRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundCaptureRequest' do
  before do
    # run before each test
    @instance = CyberSource::RefundCaptureRequest.new
  end
  ...
  describe 'test an instance of RefundCaptureRequest' do
    it 'should create an instance of RefundCaptureRequest' do
      expect(@instance).to be_instance_of(CyberSource::RefundCaptureRequest)
    end
  end
