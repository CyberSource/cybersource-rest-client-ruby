...
# Unit tests for CyberSource::Ptsv1pushfundstransferSenderInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Ptsv1pushfundstransferSenderInformation' do
  before do
    # run before each test
    @instance = CyberSource::Ptsv1pushfundstransferSenderInformation.new
  end
  ...
  describe 'test an instance of Ptsv1pushfundstransferSenderInformation' do
    it 'should create an instance of Ptsv1pushfundstransferSenderInformation' do
      expect(@instance).to be_instance_of(CyberSource::Ptsv1pushfundstransferSenderInformation)
    end
  end
