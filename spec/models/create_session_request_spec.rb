...
# Unit tests for CyberSource::CreateSessionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSessionRequest' do
  before do
    # run before each test
    @instance = CyberSource::CreateSessionRequest.new
  end
  ...
  describe 'test an instance of CreateSessionRequest' do
    it 'should create an instance of CreateSessionRequest' do
      expect(@instance).to be_instance_of(CyberSource::CreateSessionRequest)
    end
  end
