...
# Unit tests for CyberSource::TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries' do
  before do
    # run before each test
    @instance = CyberSource::TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries.new
  end
  ...
  describe 'test an instance of TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries' do
    it 'should create an instance of TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries' do
      expect(@instance).to be_instance_of(CyberSource::TssV2TransactionsPost201ResponseEmbeddedTransactionSummaries)
    end
  end
