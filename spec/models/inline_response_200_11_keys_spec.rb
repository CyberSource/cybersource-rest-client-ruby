...
# Unit tests for CyberSource::InlineResponse20011Keys
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20011Keys' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse20011Keys.new
  end
  ...
  describe 'test an instance of InlineResponse20011Keys' do
    it 'should create an instance of InlineResponse20011Keys' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse20011Keys)
    end
  end
