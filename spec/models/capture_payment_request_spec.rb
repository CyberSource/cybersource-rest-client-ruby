...
# Unit tests for CyberSource::CapturePaymentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CapturePaymentRequest' do
  before do
    # run before each test
    @instance = CyberSource::CapturePaymentRequest.new
  end
  ...
  describe 'test an instance of CapturePaymentRequest' do
    it 'should create an instance of CapturePaymentRequest' do
      expect(@instance).to be_instance_of(CyberSource::CapturePaymentRequest)
    end
  end
