...
# Unit tests for CyberSource::V2paymentsProcessingInformationAuthorizationOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V2paymentsProcessingInformationAuthorizationOptions' do
  before do
    # run before each test
    @instance = CyberSource::V2paymentsProcessingInformationAuthorizationOptions.new
  end
  ...
  describe 'test an instance of V2paymentsProcessingInformationAuthorizationOptions' do
    it 'should create an instance of V2paymentsProcessingInformationAuthorizationOptions' do
      expect(@instance).to be_instance_of(CyberSource::V2paymentsProcessingInformationAuthorizationOptions)
    end
  end
