...
# Unit tests for CyberSource::PaymentInstrument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInstrument' do
  before do
    # run before each test
    @instance = CyberSource::PaymentInstrument.new
  end
  ...
  describe 'test an instance of PaymentInstrument' do
    it 'should create an instance of PaymentInstrument' do
      expect(@instance).to be_instance_of(CyberSource::PaymentInstrument)
    end
  end
