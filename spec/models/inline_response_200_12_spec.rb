...
# Unit tests for CyberSource::InlineResponse20012
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20012' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse20012.new
  end
  ...
  describe 'test an instance of InlineResponse20012' do
    it 'should create an instance of InlineResponse20012' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse20012)
    end
  end
