...
# Unit tests for CyberSource::InlineResponse20014
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20014' do
  before do
    # run before each test
    @instance = CyberSource::InlineResponse20014.new
  end
  ...
  describe 'test an instance of InlineResponse20014' do
    it 'should create an instance of InlineResponse20014' do
      expect(@instance).to be_instance_of(CyberSource::InlineResponse20014)
    end
  end
