...
# Unit tests for CyberSource::UnifiedriskTravel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnifiedriskTravel' do
  before do
    # run before each test
    @instance = CyberSource::UnifiedriskTravel.new
  end
  ...
  describe 'test an instance of UnifiedriskTravel' do
    it 'should create an instance of UnifiedriskTravel' do
      expect(@instance).to be_instance_of(CyberSource::UnifiedriskTravel)
    end
  end
