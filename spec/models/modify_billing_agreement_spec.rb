...
# Unit tests for CyberSource::ModifyBillingAgreement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyBillingAgreement' do
  before do
    # run before each test
    @instance = CyberSource::ModifyBillingAgreement.new
  end
  ...
  describe 'test an instance of ModifyBillingAgreement' do
    it 'should create an instance of ModifyBillingAgreement' do
      expect(@instance).to be_instance_of(CyberSource::ModifyBillingAgreement)
    end
  end
