...
# Unit tests for CyberSource::TmsV1PaymentinstrumentsGet200Response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TmsV1PaymentinstrumentsGet200Response' do
  before do
    # run before each test
    @instance = CyberSource::TmsV1PaymentinstrumentsGet200Response.new
  end
  ...
  describe 'test an instance of TmsV1PaymentinstrumentsGet200Response' do
    it 'should create an instance of TmsV1PaymentinstrumentsGet200Response' do
      expect(@instance).to be_instance_of(CyberSource::TmsV1PaymentinstrumentsGet200Response)
    end
  end
