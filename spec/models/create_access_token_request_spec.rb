...
# Unit tests for CyberSource::CreateAccessTokenRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAccessTokenRequest' do
  before do
    # run before each test
    @instance = CyberSource::CreateAccessTokenRequest.new
  end
  ...
  describe 'test an instance of CreateAccessTokenRequest' do
    it 'should create an instance of CreateAccessTokenRequest' do
      expect(@instance).to be_instance_of(CyberSource::CreateAccessTokenRequest)
    end
  end
