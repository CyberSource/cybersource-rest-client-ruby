...
# Unit tests for CyberSource::RetrievalDetailsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RetrievalDetailsApi' do
  before do
    # run before each test
    @instance = CyberSource::RetrievalDetailsApi.new
  end
  ...
  describe 'test an instance of RetrievalDetailsApi' do
    it 'should create an instance of RetrievalDetailsApi' do
      expect(@instance).to be_instance_of(CyberSource::RetrievalDetailsApi)
    end
  end

  # unit tests for get_retrieval_details
  ...
  describe 'get_retrieval_details test' do
    it 'should work' do
