...
# Unit tests for CyberSource::InterchangeClearingLevelDetailsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InterchangeClearingLevelDetailsApi' do
  before do
    # run before each test
    @instance = CyberSource::InterchangeClearingLevelDetailsApi.new
  end
  ...
  describe 'test an instance of InterchangeClearingLevelDetailsApi' do
    it 'should create an instance of InterchangeClearingLevelDetailsApi' do
      expect(@instance).to be_instance_of(CyberSource::InterchangeClearingLevelDetailsApi)
    end
  end

  # unit tests for get_interchange_clearing_level_details
  ...
  describe 'get_interchange_clearing_level_details test' do
    it 'should work' do
